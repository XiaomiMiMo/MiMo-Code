...
const desktopPrefix = process.env.OPENCODE_CHANNEL === "beta" ? "mimocode-desktop-beta" : "mimocode-desktop"
const macxTarGz = `${desktopPrefix}-mac-x64.app.tar.gz`
const macaTarGz = `${desktopPrefix}-mac-arm64.app.tar.gz`
