...
const releaseId = process.env.DEVORA_RELEASE
if (!releaseId) throw new Error("DEVORA_RELEASE is required")

const version = process.env.DEVORA_VERSION
if (!version) throw new Error("DEVORA_VERSION is required")
...
const macxTarGz = "devora-desktop-mac-x64.app.tar.gz"
const macaTarGz = "devora-desktop-mac-arm64.app.tar.gz"
