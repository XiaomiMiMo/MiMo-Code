export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Devora",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Devora. ¿Quieres instalarla y reiniciar?",
