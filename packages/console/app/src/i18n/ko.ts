...
export const dict = {
  ...
  "notFound.title": "페이지를 찾을 수 없음 | MiMoCode",
  "notFound.heading": "404 - 페이지를 찾을 수 없음",
  "notFound.home": "홈",
  "notFound.docs": "문서",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "MiMoCode 밝은 로고",
  "notFound.logoDarkAlt": "MiMoCode 어두운 로고",
  ...
  "app.meta.description": "MiMoCode - 오픈 소스 코딩 에이전트.",

  "home.title": "MiMoCode | 오픈 소스 AI 코딩 에이전트",

  "temp.title": "MiMoCode | 터미널을 위해 만들어진 AI 코딩 에이전트",
  ...
  "temp.screenshot.caption": "tokyonight 테마가 적용된 MiMoCode TUI",
  "temp.screenshot.alt": "tokyonight 테마가 적용된 MiMoCode TUI",
  "temp.logoLightAlt": "MiMoCode 밝은 로고",
  "temp.logoDarkAlt": "MiMoCode 어두운 로고",
  ...
  "home.what.title": "MiMoCode란 무엇인가요?",
  "home.what.body":
    "MiMoCode는 터미널, IDE, 또는 데스크톱에서 코드를 작성할 수 있도록 도와주는 오픈 소스 에이전트입니다.",
  ...
  "home.growth.body":
    "<strong>{{stars}}</strong>개 이상의 GitHub 스타, <strong>{{contributors}}</strong>명의 기여자, <strong>{{commits}}</strong>개 이상의 커밋과 함께, MiMoCode는 매달 <strong>{{monthlyUsers}}</strong>명 이상의 개발자가 사용하고 신뢰합니다.",
  ...
  "home.privacy.body":
    "MiMoCode는 코드나 컨텍스트 데이터를 저장하지 않으므로, 프라이버시에 민감한 환경에서도 안전하게 작동합니다.",
  "home.privacy.learnMore": "더 알아보기:",
  "home.privacy.link": "프라이버시",

  "home.faq.q1": "MiMoCode란 무엇인가요?",
  "home.faq.a1":
    "MiMoCode는 어떤 AI 모델로든 코드를 작성하고 실행할 수 있도록 도와주는 오픈 소스 에이전트입니다. 터미널 기반 인터페이스, 데스크톱 앱, 또는 IDE 확장 프로그램으로 사용할 수 있습니다.",
  "home.faq.q2": "MiMoCode는 어떻게 사용하나요?",
  "home.faq.a2.before": "가장 쉬운 시작 방법은",
  "home.faq.a2.link": "소개",
  "home.faq.q3": "MiMoCode를 사용하려면 별도의 AI 구독이 필요한가요?",
  "home.faq.a3.p1": "꼭 그렇지는 않습니다. MiMoCode에는 계정 없이도 사용할 수 있는 무료 모델 세트가 포함되어 있습니다.",
  "home.faq.a3.p2.beforeZen": "이 외에도,",
  "home.faq.a3.p2.afterZen": " 계정을 생성하여 인기 있는 코딩 모델들을 사용할 수 있습니다.",
  "home.faq.a3.p3": "Zen 사용을 권장하지만, MiMoCode는 OpenAI, Anthropic, xAI 등 모든 인기 제공자와도 작동합니다.",
  "home.faq.a3.p4.beforeLocal": "또한",
  "home.faq.a3.p4.localLink": "로컬 모델",
  "home.faq.q4": "기존 AI 구독을 MiMoCode에서 사용할 수 있나요?",
  "home.faq.a4.p1":
    "네, MiMoCode는 모든 주요 제공자의 구독 플랜을 지원합니다. Claude Pro/Max, ChatGPT Plus/Pro, 또는 GitHub Copilot 구독을 사용할 수 있습니다.",
  "home.faq.q5": "MiMoCode는 터미널에서만 사용할 수 있나요?",
  "home.faq.a5.beforeDesktop": "이제 아닙니다! MiMoCode는 이제",
  "home.faq.a5.desktop": "데스크톱",
  "home.faq.a5.and": "및",
  "home.faq.a5.web": "웹",
  "home.faq.q6": "MiMoCode 비용은 얼마인가요?",
  "home.faq.a6":
    "MiMoCode는 100% 무료로 사용할 수 있습니다. 무료 모델 세트도 포함되어 있습니다. 다른 제공자를 연결할 경우 추가 비용이 발생할 수 있습니다.",
  ...
  "home.faq.q8": "MiMoCode는 오픈 소스인가요?",
  "home.faq.a8.p1": "네, MiMoCode는 완전히 오픈 소스입니다. 소스 코드는",
  ...
  "workspace.newUser.feature.lockin.body":
    "Zen을 어떤 코딩 에이전트와도 함께 사용할 수 있으며, 원할 때 언제든지 MiMoCode와 함께 다른 제공자를 계속 사용할 수 있습니다.",
  ...
  "workspace.newUser.step.login.after": "후 MiMoCode 선택",
  "workspace.newUser.step.pasteKey": "API 키 붙여넣기",
  "workspace.newUser.step.models.before": "MiMoCode를 시작하고 실행",
  ...
  "workspace.keys.subtitle": "MiMoCode 서비스 액세스를 위한 API 키를 관리하세요.",
  "workspace.keys.create": "API 키 생성",
  "workspace.keys.placeholder": "키 이름 입력",
  "workspace.keys.empty": "MiMoCode 게이트웨이 API 키 생성",
  ...
  "download.title": "MiMoCode | 다운로드",
  "download.meta.description": "macOS, Windows, Linux용 MiMoCode 다운로드",
  "download.hero.title": "MiMoCode 다운로드",
  "download.hero.subtitle": "CLI archives and install commands for macOS, Windows, and Linux",
  "download.hero.button": "{{os}}용 다운로드",
  "download.section.terminal": "MiMoCode 터미널",
  "download.section.desktop": "MiMoCode CLI Archives",
  "download.section.extensions": "MiMoCode 확장 프로그램",
  "download.section.integrations": "MiMoCode 통합",
  ...
  "download.faq.a3.beforeLocal":
    "꼭 그렇지는 않지만, 아마도 필요할 것입니다. MiMoCode를 유료 제공자에 연결하려면 AI 구독이 필요할 수 있습니다. 하지만",
  "download.faq.a3.localLink": "로컬 모델",
  "download.faq.a3.afterLocal.beforeZen": "은 무료로 사용할 수 있습니다. 우리는",
  "download.faq.a3.afterZen": " 사용을 권장하지만, MiMoCode는 OpenAI, Anthropic, xAI 등 모든 인기 제공자와 작동합니다.",

  "download.faq.a5.p1": "MiMoCode는 100% 무료로 사용할 수 있습니다.",
  "download.faq.a5.p2.beforeZen":
    "추가 비용은 모델 제공자 구독에서 발생합니다. MiMoCode는 모든 모델 제공자와 작동하지만, 우리는",
  "download.faq.a5.p2.afterZen": " 사용을 권장합니다.",

  "download.faq.a6.p1": "데이터와 정보는 MiMoCode에서 공유 링크를 생성할 때만 저장됩니다.",
