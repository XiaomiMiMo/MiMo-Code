...
export const dict = {
  ...
  "notFound.title": "Ikke funnet | MiMoCode",
  "notFound.heading": "404 - Side ikke funnet",
  "notFound.home": "Hjem",
  "notFound.docs": "Dokumentasjon",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "MiMoCode logo lys",
  "notFound.logoDarkAlt": "MiMoCode logo mørk",
  ...
  "app.meta.description": "MiMoCode - Den åpne kildekode kodingsagenten.",

  "home.title": "MiMoCode | Den åpne kildekode AI-kodingsagenten",

  "temp.title": "MiMoCode | AI-kodingsagent bygget for terminalen",
  ...
  "temp.screenshot.caption": "MiMoCode TUI med tokyonight-tema",
  "temp.screenshot.alt": "MiMoCode TUI med tokyonight-tema",
  "temp.logoLightAlt": "MiMoCode logo lys",
  "temp.logoDarkAlt": "MiMoCode logo mørk",
  ...
  "home.what.title": "Hva er MiMoCode?",
  "home.what.body": "MiMoCode er en åpen kildekode-agent som hjelper deg å skrive kode i terminal, IDE eller desktop.",
  ...
  "home.growth.body":
    "Med over <strong>{{stars}}</strong> GitHub-stjerner, <strong>{{contributors}}</strong> bidragsytere og over <strong>{{commits}}</strong> commits, brukes MiMoCode av over <strong>{{monthlyUsers}}</strong> utviklere hver måned.",
  ...
  "home.privacy.body":
    "MiMoCode lagrer ikke koden din eller kontekstdata, slik at den kan fungere i personvernsensitive miljøer.",
  "home.privacy.learnMore": "Les mer om",
  "home.privacy.link": "personvern",

  "home.faq.q1": "Hva er MiMoCode?",
  "home.faq.a1":
    "MiMoCode er en åpen kildekode-agent som hjelper deg å skrive og kjøre kode med hvilken som helst AI-modell. Den er tilgjengelig som terminalgrensesnitt, desktop-app eller IDE-utvidelse.",
  "home.faq.q2": "Hvordan bruker jeg MiMoCode?",
  "home.faq.a2.before": "Den enkleste måten å komme i gang på er å lese",
  "home.faq.a2.link": "introen",
  "home.faq.q3": "Trenger jeg ekstra AI-abonnementer for å bruke MiMoCode?",
  "home.faq.a3.p1":
    "Ikke nødvendigvis. MiMoCode kommer med et sett gratis modeller du kan bruke uten å opprette en konto.",
  "home.faq.a3.p2.beforeZen": "I tillegg kan du bruke populære kodemodeller ved å opprette en",
  "home.faq.a3.p2.afterZen": " konto.",
  "home.faq.a3.p3":
    "Vi oppfordrer til å bruke Zen, men MiMoCode fungerer også med populære leverandører som OpenAI, Anthropic, xAI osv.",
  "home.faq.a3.p4.beforeLocal": "Du kan til og med koble til dine",
  "home.faq.a3.p4.localLink": "lokale modeller",
  "home.faq.q4": "Kan jeg bruke mine eksisterende AI-abonnementer med MiMoCode?",
  "home.faq.a4.p1":
    "Ja, MiMoCode støtter abonnementer fra alle store leverandører. Du kan bruke Claude Pro/Max, ChatGPT Plus/Pro eller GitHub Copilot-abonnementer.",
  "home.faq.q5": "Kan jeg bare bruke MiMoCode i terminalen?",
  "home.faq.a5.beforeDesktop": "Ikke lenger! MiMoCode er nå tilgjengelig som en app for",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "og",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Hva koster MiMoCode?",
  "home.faq.a6":
    "MiMoCode er 100% gratis å bruke. Det kommer også med et sett gratis modeller. Det kan være ekstra kostnader hvis du kobler til en annen leverandør.",
  ...
  "home.faq.q8": "Er MiMoCode åpen kildekode?",
  "home.faq.a8.p1": "Ja, MiMoCode er fullt open source. Kildekoden er offentlig på",
  ...
  "workspace.newUser.feature.lockin.body":
    "Bruk Zen med hvilken som helst kodeagent, og fortsett å bruke andre leverandører med MiMoCode når du vil.",
  ...
  "workspace.newUser.step.login.after": "og velg MiMoCode",
  "workspace.newUser.step.pasteKey": "Lim inn API-nøkkelen",
  "workspace.newUser.step.models.before": "Start MiMoCode og kjør",
  ...
  "workspace.keys.subtitle": "Administrer API-nøklene dine for å få tilgang til MiMoCode-tjenester.",
  "workspace.keys.create": "Opprett API-nøkkel",
  "workspace.keys.placeholder": "Skriv inn navn på nøkkel",
  "workspace.keys.empty": "Opprett en MiMoCode Gateway API-nøkkel",
  ...
  "download.title": "MiMoCode | Last ned",
  "download.meta.description": "Last ned MiMoCode for macOS, Windows og Linux",
  "download.hero.title": "Last ned MiMoCode",
  ...
  "download.section.integrations": "MiMoCode Integrations",
  ...
  "download.faq.a3.beforeLocal":
    "Ikke nødvendigvis, men sannsynligvis. Du trenger et AI-abonnement hvis du vil koble MiMoCode til en betalt leverandør, selv om du kan jobbe med",
  ...
  "download.faq.a3.afterZen": ", fungerer MiMoCode med alle populære leverandører som OpenAI, Anthropic, xAI osv.",

  "download.faq.a5.p1": "MiMoCode er 100% gratis å bruke.",
  "download.faq.a5.p2.beforeZen":
    "Eventuelle ekstra kostnader kommer fra abonnementet ditt hos en modellleverandør. Selv om MiMoCode fungerer med enhver modellleverandør, anbefaler vi å bruke",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Dataene og informasjonen din lagres bare når du oppretter delbare lenker i MiMoCode.",
