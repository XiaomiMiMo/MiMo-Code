...
export const dict = {
  ...
  "notFound.title": "Bulunamadı | MiMoCode",
  "notFound.heading": "404 - Sayfa bulunamadı",
  "notFound.home": "Ana sayfa",
  "notFound.docs": "Dokümantasyon",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "MiMoCode açık logo",
  "notFound.logoDarkAlt": "MiMoCode koyu logo",
  ...
  "app.meta.description": "MiMoCode - Açık kaynaklı kodlama ajanı.",

  "home.title": "MiMoCode | Açık kaynaklı yapay zeka kodlama ajanı",

  "temp.title": "MiMoCode | Terminal için geliştirilmiş yapay zeka kodlama ajanı",
  ...
  "temp.screenshot.caption": "MiMoCode TUI ve tokyonight teması",
  "temp.screenshot.alt": "tokyonight temalı MiMoCode TUI",
  "temp.logoLightAlt": "MiMoCode açık logo",
  "temp.logoDarkAlt": "MiMoCode koyu logo",
  ...
  "home.what.title": "MiMoCode nedir?",
  "home.what.body":
    "MiMoCode, terminalinizde, IDE'nizde veya masaüstünde kod yazmanıza yardım eden açık kaynaklı bir ajandır.",
  ...
  "home.growth.body":
    "GitHub'da <strong>{{stars}}</strong>+ yıldız, <strong>{{contributors}}</strong> katılımcı ve <strong>{{commits}}</strong>+ commit ile MiMoCode, her ay <strong>{{monthlyUsers}}</strong>+ geliştirici tarafından kullanılıyor ve güveniliyor.",
  ...
  "home.privacy.body":
    "MiMoCode kodunuzu veya bağlam verilerinizi saklamaz; bu sayede gizliliğe duyarlı ortamlarda çalışabilir.",
  "home.privacy.learnMore": "Hakkında daha fazla bilgi:",
  "home.privacy.link": "gizlilik",

  "home.faq.q1": "MiMoCode nedir?",
  "home.faq.a1":
    "MiMoCode, herhangi bir AI modeliyle kod yazmanıza ve çalıştırmanıza yardım eden açık kaynaklı bir ajandır. Terminal arayüzü, masaüstü uygulaması veya IDE uzantısı olarak kullanılabilir.",
  "home.faq.q2": "MiMoCode'u nasıl kullanırım?",
  "home.faq.a2.before": "Başlamanın en kolay yolu",
  "home.faq.a2.link": "girişi okumaktır",
  "home.faq.q3": "MiMoCode için ek AI aboneliklerine ihtiyacım var mı?",
  "home.faq.a3.p1": "Şart değil. MiMoCode, hesap açmadan kullanabileceğiniz ücretsiz modellerle gelir.",
  ...
  "home.faq.a3.p3": "Zen'i öneriyoruz, ancak MiMoCode OpenAI, Anthropic, xAI gibi popüler sağlayıcılarla da çalışır.",
  "home.faq.a3.p4.beforeLocal": "Hatta",
  "home.faq.a3.p4.localLink": "yerel modellerinizi bağlayabilirsiniz",
  "home.faq.q4": "Mevcut AI aboneliklerimi MiMoCode ile kullanabilir miyim?",
  "home.faq.a4.p1":
    "Evet. MiMoCode tüm büyük sağlayıcıların aboneliklerini destekler. Claude Pro/Max, ChatGPT Plus/Pro veya GitHub Copilot kullanabilirsiniz.",
  "home.faq.q5": "MiMoCode'u sadece terminalde mi kullanabilirim?",
  "home.faq.a5.beforeDesktop": "Artık hayır! MiMoCode artık sizin bu cihazlarınıza",
  "home.faq.a5.desktop": "masaüstü",
  "home.faq.a5.and": "ve",
  "home.faq.a5.web": "web",
  "home.faq.q6": "MiMoCode ne kadar?",
  "home.faq.a6":
    "MiMoCode %100 ücretsizdir. Ayrıca ücretsiz model setiyle gelir. Başka bir sağlayıcı bağlarsanız ek maliyetler olabilir.",
  ...
  "home.faq.q8": "MiMoCode açık kaynak mı?",
  "home.faq.a8.p1": "Evet, MiMoCode tamamen açık kaynaktır. Kaynak kodu",
  "home.faq.a8.p2": "'da",
  ...
  "workspace.newUser.feature.lockin.body":
    "Zen'i herhangi bir kodlama ajanıyla kullanın ve istediğiniz zaman MiMoCode ile diğer sağlayıcıları kullanmaya devam edin.",
  ...
  "workspace.newUser.step.login.after": "ve MiMoCode seçeneğini seçin",
  "workspace.newUser.step.pasteKey": "API anahtarınızı yapıştırın",
  "workspace.newUser.step.models.before": "MiMoCode'u başlatın ve çalıştırın",
  ...
  "workspace.keys.subtitle": "MiMoCode hizmetlerine erişim için API anahtarlarınızı yönetin.",
  "workspace.keys.create": "API Anahtarı Oluştur",
  "workspace.keys.placeholder": "Anahtar adını girin",
  "workspace.keys.empty": "Bir MiMoCode Gateway API anahtarı oluşturun",
  ...
  "download.title": "MiMoCode | İndir",
  "download.meta.description": "MiMoCode'u macOS, Windows ve Linux için indirin",
  "download.hero.title": "MiMoCode'u İndir",
  ...
  "download.section.extensions": "MiMoCode Eklentileri",
  "download.section.integrations": "MiMoCode Entegrasyonları",
  ...
  "download.faq.a3.beforeLocal":
    "Tam olarak değil, ama muhtemelen. MiMoCode'u ücretli bir sağlayıcıya bağlamak istiyorsanız bir AI aboneliği gerekir, ancak",
  ...
  "download.faq.a3.afterZen":
    " kullanmaya teşvik ediyoruz, ancak MiMoCode OpenAI, Anthropic, xAI vb. gibi tüm popüler sağlayıcılarla çalışır.",

  "download.faq.a5.p1": "MiMoCode %100 ücretsizdir.",
  "download.faq.a5.p2.beforeZen":
    "Ek maliyetler, bir model sağlayıcısına olan aboneliğinizden gelir. MiMoCode herhangi bir model sağlayıcısıyla çalışır, ancak",
  "download.faq.a5.p2.afterZen": " kullanmanızı öneririz.",

  "download.faq.a6.p1":
    "Verileriniz ve bilginiz yalnızca MiMoCode'da paylaşılabilir bağlantılar oluşturduğunuzda saklanır.",
