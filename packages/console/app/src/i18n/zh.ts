...
export const dict = {
  ...
  "notFound.title": "未找到页面 | MiMoCode",
  "notFound.heading": "404 - 页面未找到",
  "notFound.home": "首页",
  "notFound.docs": "文档",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "MiMoCode logo 亮色",
  "notFound.logoDarkAlt": "MiMoCode logo 暗色",
  ...
  "app.meta.description": "MiMoCode - 开源编程代理。",

  "home.title": "MiMoCode | 开源 AI 编程代理",

  "temp.title": "MiMoCode | 专为终端打造的 AI 编程代理",
  ...
  "temp.screenshot.caption": "使用 Tokyonight 主题的 MiMoCode TUI",
  "temp.screenshot.alt": "使用 Tokyonight 主题的 MiMoCode TUI",
  "temp.logoLightAlt": "MiMoCode logo 亮色",
  "temp.logoDarkAlt": "MiMoCode logo 暗色",
  ...
  "home.what.title": "什么是 MiMoCode？",
  "home.what.body": "MiMoCode 是一个开源代理，帮助您在终端、IDE 或桌面端编写代码。",
  ...
  "home.growth.body":
    "拥有超过 <strong>{{stars}}</strong> 颗 GitHub Star，<strong>{{contributors}}</strong> 位贡献者，以及超过 <strong>{{commits}}</strong> 次提交，MiMoCode 每月被超过 <strong>{{monthlyUsers}}</strong> 名开发者使用并信赖。",
  "home.growth.githubStars": "GitHub Stars",
  "home.growth.contributors": "贡献者",
  "home.growth.monthlyDevs": "月活开发者",

  "home.privacy.title": "隐私优先的设计",
  "home.privacy.body": "MiMoCode 不存储您的任何代码或上下文数据，确保可以在对隐私敏感的环境中运行。",
  "home.privacy.learnMore": "了解更多关于",
  "home.privacy.link": "隐私",

  "home.faq.q1": "什么是 MiMoCode？",
  "home.faq.a1": "MiMoCode 是一个开源代理，帮助您使用任意 AI 模型编写和运行代码。它提供终端界面、桌面应用及 IDE 扩展。",
  "home.faq.q2": "如何使用 MiMoCode？",
  "home.faq.a2.before": "最简单的入门方式是阅读",
  "home.faq.a2.link": "介绍",
  "home.faq.q3": "使用 MiMoCode 需要额外的 AI 订阅吗？",
  "home.faq.a3.p1": "不一定。MiMoCode 自带一组免费模型，无需创建账户即可使用。",
  "home.faq.a3.p2.beforeZen": "此外，您可以通过创建",
  "home.faq.a3.p2.afterZen": "账户来使用流行的编程模型。",
  "home.faq.a3.p3": "虽然我们鼓励使用 Zen，但 MiMoCode 也支持所有主流提供商，如 OpenAI, Anthropic, xAI 等。",
  "home.faq.a3.p4.beforeLocal": "您甚至可以连接您的",
  "home.faq.a3.p4.localLink": "本地模型",
  "home.faq.q4": "我可以使用现有的 AI 订阅吗？",
  "home.faq.a4.p1":
    "可以，MiMoCode 支持所有主流提供商的订阅计划。您可以使用您的 Claude Pro/Max, ChatGPT Plus/Pro, 或 GitHub Copilot 订阅。",
  "home.faq.q5": "MiMoCode 只能在终端使用吗？",
  "home.faq.a5.beforeDesktop": "不再是了！MiMoCode 现在也提供",
  "home.faq.a5.desktop": "桌面端应用",
  "home.faq.a5.and": "和",
  "home.faq.a5.web": "网页端",
  "home.faq.q6": "MiMoCode 多少钱？",
  "home.faq.a6": "MiMoCode 是 100% 免费使用的。它还自带一组免费模型。如果您连接其他提供商，可能会产生额外费用。",
  "home.faq.q7": "数据和隐私如何？",
  ...
  "home.faq.q8": "MiMoCode 是开源的吗？",
  "home.faq.a8.p1": "是的，MiMoCode 是完全开源的。源代码公开在",
  "home.faq.a8.p2": "遵循",
  ...
  "workspace.newUser.feature.lockin.body":
    "将 Zen 与任何编程代理结合使用，并在需要时继续在 MiMoCode 中使用其他提供商。",
  ...
  "workspace.newUser.step.login.after": "并选择 MiMoCode",
  "workspace.newUser.step.pasteKey": "粘贴您的 API 密钥",
  "workspace.newUser.step.models.before": "启动 MiMoCode 并运行",
  ...
  "workspace.keys.subtitle": "管理访问 MiMoCode 服务的 API 密钥。",
  "workspace.keys.create": "创建 API 密钥",
  "workspace.keys.placeholder": "输入密钥名称",
  "workspace.keys.empty": "创建 MiMoCode 网关 API 密钥",
  ...
  "download.title": "MiMoCode | 下载",
  "download.meta.description": "下载适用于 macOS, Windows, 和 Linux 的 MiMoCode",
  "download.hero.title": "下载 MiMoCode",
  "download.hero.subtitle": "CLI archives and install commands for macOS, Windows, and Linux",
  "download.hero.button": "下载 {{os}} 版",
  "download.section.terminal": "MiMoCode 终端",
  "download.section.desktop": "MiMoCode CLI Archives",
  "download.section.extensions": "MiMoCode 扩展",
  "download.section.integrations": "MiMoCode 集成",
  ...
  "download.faq.a3.beforeLocal":
    "不一定，但可能需要。如果您想将 MiMoCode 连接到付费提供商，您需要 AI 订阅，尽管您可以配合",
  "download.faq.a3.localLink": "本地模型",
  "download.faq.a3.afterLocal.beforeZen": "免费使用。虽然我们鼓励用户使用",
  "download.faq.a3.afterZen": "，但 MiMoCode 支持所有主流提供商，如 OpenAI, Anthropic, xAI 等。",

  "download.faq.a5.p1": "MiMoCode 是 100% 免费使用的。",
  "download.faq.a5.p2.beforeZen":
    "任何额外费用都来自您对模型提供商的订阅。虽然 MiMoCode 支持任何模型提供商，但我们建议使用",
  "download.faq.a5.p2.afterZen": "。",

  "download.faq.a6.p1": "只有当您在 MiMoCode 中创建分享链接时，您的数据和信息才会被存储。",
