export const dict = {
  ...
  "notFound.title": "Not Found | MiMoCode",
  ...
  "app.meta.description": "MiMoCode - The open source coding agent.",

  "home.title": "MiMoCode | The open source AI coding agent",

  "temp.title": "MiMoCode | AI coding agent built for the terminal",
  ...
  "temp.screenshot.caption": "MiMoCode TUI with the tokyonight theme",
  "temp.screenshot.alt": "MiMoCode TUI with tokyonight theme",
  ...
  "home.what.title": "What is MiMoCode?",
  "home.what.body": "MiMoCode is an open source agent that helps you write code in your terminal, IDE, or desktop.",
  ...
  "home.growth.body":
    "With over <strong>{{stars}}</strong> GitHub stars, <strong>{{contributors}}</strong> contributors, and over <strong>{{commits}}</strong> commits, MiMoCode is used and trusted by over <strong>{{monthlyUsers}}</strong> developers every month.",
  ...
  "home.privacy.body":
    "MiMoCode does not store any of your code or context data, so that it can operate in privacy sensitive environments.",
  "home.privacy.learnMore": "Learn more about",
  "home.privacy.link": "privacy",

  "home.faq.q1": "What is MiMoCode?",
  "home.faq.a1":
    "MiMoCode is an open source agent that helps you write and run code with any AI model. It's available as a terminal-based interface, desktop app, or IDE extension.",
  "home.faq.q2": "How do I use MiMoCode?",
  "home.faq.a2.before": "The easiest way to get started is to read the",
  "home.faq.a2.link": "intro",
  "home.faq.q3": "Do I need extra AI subscriptions to use MiMoCode?",
  "home.faq.a3.p1":
    "Not necessarily, MiMoCode comes with a set of free models that you can use without creating an account.",
  ...
  "home.faq.a3.p3":
    "While we encourage users to use Zen, MiMoCode also works with all popular providers such as OpenAI, Anthropic, xAI etc.",
  "home.faq.a3.p4.beforeLocal": "You can even connect your",
  "home.faq.a3.p4.localLink": "local models",
  "home.faq.q4": "Can I use my existing AI subscriptions with MiMoCode?",
  "home.faq.a4.p1":
    "Yes, MiMoCode supports subscription plans from all major providers. You can use your Claude Pro/Max, ChatGPT Plus/Pro, or GitHub Copilot subscriptions.",
  "home.faq.q5": "Can I only use MiMoCode in the terminal?",
  "home.faq.a5.beforeDesktop": "Not anymore! MiMoCode is now available as an app for your",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "and",
  "home.faq.a5.web": "web",
  "home.faq.q6": "How much does MiMoCode cost?",
  "home.faq.a6":
    "MiMoCode is 100% free to use. It also comes with a set of free models. There might be additional costs if you connect any other provider.",
  ...
  "home.faq.q8": "Is MiMoCode open source?",
  "home.faq.a8.p1": "Yes, MiMoCode is fully open source. The source code is public on",
  ...
  "workspace.newUser.feature.lockin.body":
    "Use Zen with any coding agent, and continue using other providers with MiMoCode whenever you want.",
  ...
  "workspace.newUser.step.login.after": "and select MiMoCode",
  "workspace.newUser.step.pasteKey": "Paste your API key",
  "workspace.newUser.step.models.before": "Start MiMoCode and run",
  ...
  "workspace.keys.subtitle": "Manage your API keys for accessing MiMoCode services.",
  "workspace.keys.create": "Create API Key",
  "workspace.keys.placeholder": "Enter key name",
  "workspace.keys.empty": "Create a MiMoCode Gateway API key",
  ...
  "download.meta.description": "Download MiMoCode for macOS, Windows, and Linux",
  "download.hero.title": "Download MiMoCode",
  ...
  "download.faq.a3.beforeLocal":
    "Not necessarily, but probably. You'll need an AI subscription if you want to connect MiMoCode to a paid provider, although you can work with",
  "download.faq.a3.localLink": "local models",
  "download.faq.a3.afterLocal.beforeZen": "for free. While we encourage users to use",
  "download.faq.a3.afterZen": ", MiMoCode works with all popular providers such as OpenAI, Anthropic, xAI etc.",

  "download.faq.a5.p1": "MiMoCode is 100% free to use.",
  "download.faq.a5.p2.beforeZen":
    "Any additional costs will come from your subscription to a model provider. While MiMoCode works with any model provider, we recommend using",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Your data and information is only stored when you create sharable links in MiMoCode.",
