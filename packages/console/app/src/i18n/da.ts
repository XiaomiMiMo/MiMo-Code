...
export const dict = {
  ...
  "notFound.title": "Ikke fundet | MiMoCode",
  ...
  "app.meta.description": "MiMoCode - Den open source kodningsagent.",

  "home.title": "MiMoCode | Den open source AI-kodningsagent",

  "temp.title": "MiMoCode | AI-kodningsagent bygget til terminalen",
  ...
  "temp.screenshot.caption": "MiMoCode TUI med tokyonight-temaet",
  "temp.screenshot.alt": "MiMoCode TUI med tokyonight-temaet",
  ...
  "home.what.title": "Hvad er MiMoCode?",
  "home.what.body":
    "MiMoCode er en open source agent, der hjælper dig med at skrive kode i din terminal, IDE eller desktop.",
  ...
  "home.growth.body":
    "Med over <strong>{{stars}}</strong> GitHub-stjerner, <strong>{{contributors}}</strong> bidragsydere og over <strong>{{commits}}</strong> commits bruges MiMoCode af over <strong>{{monthlyUsers}}</strong> udviklere hver måned.",
  ...
  "home.privacy.body":
    "MiMoCode gemmer ikke din kode eller kontekstdata, så den kan bruges i privatlivsfølsomme miljøer.",
  "home.privacy.learnMore": "Læs mere om",
  "home.privacy.link": "privatliv",

  "home.faq.q1": "Hvad er MiMoCode?",
  "home.faq.a1":
    "MiMoCode er en open source agent, der hjælper dig med at skrive og køre kode med enhver AI-model. Den er tilgængelig som terminal-interface, desktop-app eller IDE-udvidelse.",
  "home.faq.q2": "Hvordan bruger jeg MiMoCode?",
  "home.faq.a2.before": "Den nemmeste måde at komme i gang på er at læse",
  "home.faq.a2.link": "introen",
  "home.faq.q3": "Skal jeg have ekstra AI-abonnementer for at bruge MiMoCode?",
  "home.faq.a3.p1":
    "Ikke nødvendigvis. MiMoCode kommer med gratis modeller, som du kan bruge uden at oprette en konto.",
  "home.faq.a3.p2.beforeZen": "Derudover kan du bruge populære kodningsmodeller ved at oprette en",
  "home.faq.a3.p2.afterZen": " konto.",
  "home.faq.a3.p3":
    "Vi opfordrer til at bruge Zen, men MiMoCode virker også med populære udbydere som OpenAI, Anthropic, xAI osv.",
  "home.faq.a3.p4.beforeLocal": "Du kan endda forbinde dine",
  "home.faq.a3.p4.localLink": "lokale modeller",
  "home.faq.q4": "Kan jeg bruge mine eksisterende AI-abonnementer med MiMoCode?",
  "home.faq.a4.p1":
    "Ja. MiMoCode understøtter abonnementer fra alle store udbydere. Du kan bruge Claude Pro/Max, ChatGPT Plus/Pro eller GitHub Copilot.",
  "home.faq.q5": "Kan jeg kun bruge MiMoCode i terminalen?",
  "home.faq.a5.beforeDesktop": "Ikke længere! MiMoCode er nu tilgængelig som en app til",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "og",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Hvad koster MiMoCode?",
  "home.faq.a6":
    "MiMoCode er 100% gratis at bruge. Det kommer også med et sæt gratis modeller. Der kan være ekstra omkostninger, hvis du forbinder en anden udbyder.",
  ...
  "home.faq.q8": "Er MiMoCode open source?",
  "home.faq.a8.p1": "Ja, MiMoCode er fuldt open source. Kildekoden er offentlig på",
  ...
  "workspace.newUser.feature.lockin.body":
    "Brug Zen med en hvilken som helst kodningsagent, og fortsæt med at bruge andre udbydere med MiMoCode, når du vil.",
  ...
  "workspace.newUser.step.login.after": "og vælg MiMoCode",
  "workspace.newUser.step.pasteKey": "Indsæt din API-nøgle",
  "workspace.newUser.step.models.before": "Start MiMoCode og kør",
  ...
  "workspace.keys.subtitle": "Administrer dine API-nøgler for at få adgang til MiMoCode-tjenester.",
  "workspace.keys.create": "Opret API-nøgle",
  "workspace.keys.placeholder": "Indtast nøglenavn",
  "workspace.keys.empty": "Opret en MiMoCode Gateway API-nøgle",
  ...
  "download.meta.description": "Download MiMoCode til macOS, Windows og Linux",
  ...
  "download.faq.a3.beforeLocal":
    "Ikke nødvendigvis, men sandsynligvis. Du skal bruge et AI-abonnement hvis du vil forbinde MiMoCode til en betalt udbyder, men du kan arbejde med",
  ...
  "download.faq.a3.afterZen": ", fungerer MiMoCode med alle populære udbydere som OpenAI, Anthropic, xAI osv.",

  "download.faq.a5.p1": "MiMoCode er 100% gratis at bruge.",
  "download.faq.a5.p2.beforeZen":
    "Eventuelle ekstra omkostninger kommer fra dit abonnement hos en modeludbyder. Selvom MiMoCode fungerer med enhver modeludbyder, anbefaler vi at bruge",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Dine data og oplysninger gemmes kun når du opretter delbare links i MiMoCode.",
