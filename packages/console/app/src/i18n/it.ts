...
export const dict = {
  ...
  "notFound.title": "Non trovato | MiMoCode",
  "notFound.heading": "404 - Pagina non trovata",
  "notFound.home": "Home",
  "notFound.docs": "Documentazione",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "logo chiaro di MiMoCode",
  "notFound.logoDarkAlt": "logo scuro di MiMoCode",
  ...
  "app.meta.description": "MiMoCode - L'agente di programmazione open source.",

  "home.title": "MiMoCode | L'agente di coding IA open source",

  "temp.title": "MiMoCode | Agente di coding IA costruito per il terminale",
  ...
  "temp.screenshot.caption": "MiMoCode TUI con il tema tokyonight",
  "temp.screenshot.alt": "MiMoCode TUI con tema tokyonight",
  "temp.logoLightAlt": "logo chiaro di MiMoCode",
  "temp.logoDarkAlt": "logo scuro di MiMoCode",
  ...
  "home.what.title": "Che cos'è MiMoCode?",
  "home.what.body": "MiMoCode è un agente open source che ti aiuta a scrivere codice nel terminale, IDE o desktop.",
  ...
  "home.growth.body":
    "Con oltre <strong>{{stars}}</strong> stelle su GitHub, <strong>{{contributors}}</strong> contributori e oltre <strong>{{commits}}</strong> commit, MiMoCode è usato e apprezzato da oltre <strong>{{monthlyUsers}}</strong> sviluppatori ogni mese.",
  ...
  "home.privacy.body":
    "MiMoCode non archivia il tuo codice né i dati di contesto, così può operare in ambienti sensibili alla privacy.",
  "home.privacy.learnMore": "Scopri di più su",
  "home.privacy.link": "privacy",

  "home.faq.q1": "Che cos'è MiMoCode?",
  "home.faq.a1":
    "MiMoCode è un agente open source che ti aiuta a scrivere ed eseguire codice con qualsiasi modello di IA. È disponibile come interfaccia terminale, app desktop o estensione IDE.",
  "home.faq.q2": "Come uso MiMoCode?",
  "home.faq.a2.before": "Il modo più semplice per iniziare è leggere l'",
  "home.faq.a2.link": "introduzione",
  "home.faq.q3": "Mi servono abbonamenti IA extra per usare MiMoCode?",
  "home.faq.a3.p1":
    "Non necessariamente: MiMoCode include un set di modelli gratuiti che puoi usare senza creare un account.",
  "home.faq.a3.p2.beforeZen": "Inoltre, puoi usare modelli popolari per il coding creando un account",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Anche se incoraggiamo gli utenti a usare Zen, MiMoCode funziona anche con i provider più diffusi come OpenAI, Anthropic, xAI, ecc.",
  "home.faq.a3.p4.beforeLocal": "Puoi anche collegare i tuoi",
  "home.faq.a3.p4.localLink": "modelli locali",
  "home.faq.q4": "Posso usare i miei abbonamenti IA esistenti con MiMoCode?",
  "home.faq.a4.p1":
    "Sì, MiMoCode supporta gli abbonamenti dei principali provider. Puoi usare Claude Pro/Max, ChatGPT Plus/Pro o GitHub Copilot.",
  "home.faq.q5": "Posso usare MiMoCode solo nel terminale?",
  "home.faq.a5.beforeDesktop": "Non più! MiMoCode ora è disponibile come app per",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "e",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Quanto costa MiMoCode?",
  "home.faq.a6":
    "MiMoCode è gratuito al 100%. Include anche un set di modelli gratuiti. Potrebbero esserci costi aggiuntivi se colleghi altri provider.",
  ...
  "home.faq.q8": "MiMoCode è open source?",
  "home.faq.a8.p1": "Sì, MiMoCode è completamente open source. Il codice sorgente è pubblico su",
  ...
  "workspace.newUser.feature.lockin.body":
    "Usa Zen con qualsiasi agente di coding, e continua a usare altri provider con MiMoCode quando vuoi.",
  ...
  "workspace.newUser.step.login.after": "e seleziona MiMoCode",
  "workspace.newUser.step.pasteKey": "Incolla la tua chiave API",
  "workspace.newUser.step.models.before": "Avvia MiMoCode ed esegui",
  ...
  "workspace.keys.subtitle": "Gestisci le tue chiavi API per accedere ai servizi MiMoCode.",
  "workspace.keys.create": "Crea Chiave API",
  "workspace.keys.placeholder": "Inserisci nome chiave",
  "workspace.keys.empty": "Crea una chiave API MiMoCode Gateway",
  ...
  "download.meta.description": "Scarica MiMoCode per macOS, Windows e Linux",
  "download.hero.title": "Scarica MiMoCode",
  ...
  "download.faq.a3.beforeLocal":
    "Non necessariamente, ma probabilmente. Avrai bisogno di un abbonamento IA se vuoi collegare MiMoCode a un provider a pagamento, sebbene tu possa lavorare con",
  ...
  "download.faq.a3.afterZen": ", MiMoCode funziona con tutti i provider popolari come OpenAI, Anthropic, xAI ecc.",

  "download.faq.a5.p1": "MiMoCode è gratuito al 100%.",
  "download.faq.a5.p2.beforeZen":
    "Eventuali costi aggiuntivi proverranno dal tuo abbonamento a un provider di modelli. Mentre MiMoCode funziona con qualsiasi provider di modelli, raccomandiamo di usare",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "I tuoi dati e informazioni sono archiviati solo quando crei link condivisibili in MiMoCode.",
