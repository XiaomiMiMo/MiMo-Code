...
export const dict = {
  ...
  "notFound.title": "找不到頁面 | MiMoCode",
  "notFound.heading": "404 - 找不到頁面",
  "notFound.home": "首頁",
  "notFound.docs": "文件",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "MiMoCode 淺色標誌",
  "notFound.logoDarkAlt": "MiMoCode 深色標誌",
  ...
  "app.meta.description": "MiMoCode - 開源編碼代理。",

  "home.title": "MiMoCode | 開源 AI 編碼代理",

  "temp.title": "MiMoCode | 專為終端打造的 AI 編碼代理",
  ...
  "temp.screenshot.caption": "使用 tokyonight 主題的 MiMoCode TUI",
  "temp.screenshot.alt": "使用 tokyonight 主題的 MiMoCode TUI",
  "temp.logoLightAlt": "MiMoCode 淺色標誌",
  "temp.logoDarkAlt": "MiMoCode 深色標誌",
  ...
  "home.what.title": "什麼是 MiMoCode？",
  "home.what.body": "MiMoCode 是一個開源代理，幫助你在終端、IDE 或桌面端編寫程式碼。",
  ...
  "home.growth.body":
    "擁有超過 <strong>{{stars}}</strong> 個 GitHub Star、<strong>{{contributors}}</strong> 位貢獻者以及超過 <strong>{{commits}}</strong> 次提交，MiMoCode 每月被超過 <strong>{{monthlyUsers}}</strong> 名開發者使用並信賴。",
  "home.growth.githubStars": "GitHub Star",
  "home.growth.contributors": "貢獻者",
  "home.growth.monthlyDevs": "每月活躍開發者",

  "home.privacy.title": "隱私優先",
  "home.privacy.body": "MiMoCode 不儲存你的程式碼或上下文資料，因此可以在注重隱私的環境中運作。",
  "home.privacy.learnMore": "了解更多關於",
  "home.privacy.link": "隱私",

  "home.faq.q1": "什麼是 MiMoCode？",
  "home.faq.a1":
    "MiMoCode 是一個開源代理，幫助你使用任意 AI 模型編寫並執行程式碼。它提供終端介面、桌面應用程式或 IDE 擴充功能。",
  "home.faq.q2": "如何使用 MiMoCode？",
  "home.faq.a2.before": "最簡單的方式是先閱讀",
  "home.faq.a2.link": "入門介紹",
  "home.faq.q3": "使用 MiMoCode 需要額外的 AI 訂閱嗎？",
  "home.faq.a3.p1": "不一定。MiMoCode 自帶一組免費模型，無需建立帳號即可使用。",
  "home.faq.a3.p2.beforeZen": "此外，你可以透過建立",
  "home.faq.a3.p2.afterZen": "帳號使用常見的編碼模型。",
  "home.faq.a3.p3": "我們鼓勵使用 Zen，但 MiMoCode 也支援 OpenAI、Anthropic、xAI 等主流供應商。",
  "home.faq.a3.p4.beforeLocal": "你還可以連接你的",
  "home.faq.a3.p4.localLink": "本地模型",
  "home.faq.q4": "可以使用我現有的 AI 訂閱嗎？",
  "home.faq.a4.p1":
    "可以。MiMoCode 支援主流供應商的訂閱方案，包括 Claude Pro/Max、ChatGPT Plus/Pro 與 GitHub Copilot。",
  "home.faq.q5": "MiMoCode 只能在終端中使用嗎？",
  "home.faq.a5.beforeDesktop": "不再是了！MiMoCode 現在也提供",
  "home.faq.a5.desktop": "桌面端",
  "home.faq.a5.and": "與",
  "home.faq.a5.web": "網頁端",
  "home.faq.q6": "MiMoCode 價格如何？",
  "home.faq.a6": "MiMoCode 100% 免費使用。它也自帶一組免費模型。如果你連接其他供應商，可能會產生額外費用。",
  ...
  "home.faq.q8": "MiMoCode 是開源的嗎？",
  "home.faq.a8.p1": "是的，MiMoCode 完全開源。原始碼公開在",
  "home.faq.a8.p2": "並採用",
  ...
  "workspace.newUser.feature.lockin.body":
    "將 Zen 與任何編碼代理結合使用，並在需要時隨時使用 MiMoCode 連接其他供應商。",
  ...
  "workspace.newUser.step.login.after": "並選擇 MiMoCode",
  "workspace.newUser.step.pasteKey": "貼上你的 API 金鑰",
  "workspace.newUser.step.models.before": "啟動 MiMoCode 並執行",
  ...
  "workspace.keys.subtitle": "管理你的 API 金鑰以存取 MiMoCode 服務。",
  "workspace.keys.create": "建立 API 金鑰",
  "workspace.keys.placeholder": "輸入金鑰名稱",
  "workspace.keys.empty": "建立 MiMoCode 閘道器 API 金鑰",
  ...
  "download.title": "MiMoCode | 下載",
  "download.meta.description": "下載適用於 macOS、Windows 與 Linux 的 MiMoCode",
  "download.hero.title": "下載 MiMoCode",
  "download.hero.subtitle": "CLI archives and install commands for macOS, Windows, and Linux",
  "download.hero.button": "下載 {{os}} 版",
  "download.section.terminal": "MiMoCode 終端",
  "download.section.desktop": "MiMoCode CLI Archives",
  "download.section.extensions": "MiMoCode 擴充功能",
  "download.section.integrations": "MiMoCode 整合",
  ...
  "download.faq.a3.beforeLocal":
    "不一定，但很可能需要。如果你想將 MiMoCode 連接到付費供應商，你需要 AI 訂閱，不過你也可以使用",
  "download.faq.a3.localLink": "本地模型",
  "download.faq.a3.afterLocal.beforeZen": "免費。我們也推薦使用",
  "download.faq.a3.afterZen": "，但 MiMoCode 同樣支援 OpenAI、Anthropic、xAI 等所有主流供應商。",

  "download.faq.a5.p1": "MiMoCode 100% 免費使用。",
  "download.faq.a5.p2.beforeZen": "額外費用來自你對模型供應商的訂閱。雖然 MiMoCode 支援任何模型供應商，但我們建議使用",
  "download.faq.a5.p2.afterZen": "。",

  "download.faq.a6.p1": "你的資料與資訊只會在你於 MiMoCode 中建立可分享連結時被儲存。",
