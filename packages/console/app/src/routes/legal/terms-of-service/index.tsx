...
export default function TermsOfService() {
  ...
  return (
    <main data-page="legal">
      <Title>Devora | Terms of Service</Title>
      <LocaleLinks path="/legal/terms-of-service" />
      <Meta name="description" content="Devora terms of service" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                Welcome to Devora. Please read on to learn the rules and restrictions that govern your use of
                Devora&apos;s website, inference product and hosted software offering (the "Services"). If you have
                any questions, comments, or concerns regarding these terms or the Services, please contact us at:
              </p>

              <p>
                Email: <a href="https://github.com/SheriAkhtamov/Devora/issues">Devora GitHub Issues</a>
              </p>

              <p>
                These Terms of Use (the "Terms") are a binding contract between you and{" "}
                <strong>Sheri Akhtamov</strong>, maintaining Devora ("Devora," "we" and "us"). Your use of the
                Services in any way means that you agree to all of these Terms, and these Terms will remain in effect
                while you use the Services. These Terms include the provisions in this document as well as those in the
                Privacy Policy <a href={language.route("/legal/privacy-policy")}>Devora Privacy Policy</a>.{" "}
                <strong>
              ...
              <h2 id="what-is-devora">What is Devora?</h2>
              <p>
                Devora is an AI-powered coding agent that helps you write, understand, and modify code using large
                language models. Certain of these large language models are provided by third parties ("Third Party
                Models") and certain of these models are provided directly by us if you use the Devora Zen paid
                offering ("Zen"). Regardless of whether you use Third Party Models or Zen, Devora enables you to
              ...
              <p>
                ...
                the Devora repository or website, send you an email, and/or notify you by some other means.
              </p>
              ...
              <p>
                Devora takes the privacy of its users very seriously. For the current Devora Privacy Policy, please
                click here <a href={language.route("/legal/privacy-policy")}>Devora Privacy Policy</a>.
              </p>
              ...
              <p>
                ...
                us personal information, please contact us at <a href="https://github.com/SheriAkhtamov/Devora/issues">Devora GitHub Issues</a>.
              </p>

              <h2 id="what-are-the-basics">What are the basics of using Devora?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by Devora;
                </li>
                <li>
              ...
              <p>
                If you use Devora with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                ...
                Devora. Your ability to access Third Party Models is contingent on you having API keys or otherwise
                having the right to access such Third Party Models.
              </p>

              <p>
                Devora has no control over, and assumes no responsibility for, the content, accuracy, privacy
              ...
              <h2 id="will-devora-ever-change-the-services">Will Devora ever change the Services?</h2>
              <p>
              ...
              <p>
                ...
                <a href={language.route("/zen")}>Devora Zen</a> for a description of the current Paid
              ...
              <p>
                ...
                <a href="https://github.com/SheriAkhtamov/Devora">Devora repository</a>.
              </p>
              ...
              <p>
                ...
                <a href="https://github.com/SheriAkhtamov/Devora/issues">Devora GitHub Issues</a>.
              </p>
              ...
              <p>
                ...
                <a href={language.route("/legal/privacy-policy")}>Devora Privacy Policy</a>, as well
                as the licenses above, to understand how we treat information you provide to us after you have stopped
                using our Services.
              </p>

              <p>
                Devora is also free to terminate (or suspend access to) your use of the Services for any reason in our
                discretion, including your breach of these Terms. Devora has the sole right to decide whether you are
              ...
              <p>
                Devora and its licensors, suppliers, partners, parent, subsidiaries or affiliated entities, and each
                of their respective officers, directors, members, employees, consultants, contract employees,
                representatives and agents, and each of their respective successors and assigns (Devora and all such
                parties together, the "Devora Parties") make no representations or warranties concerning the Services,
                including without limitation regarding any Content contained in or accessed through the Services, and
                the Devora Parties will not be responsible or liable for the accuracy, copyright compliance, legality,
                ...
                participation in, the Services. The Devora Parties make no representations or warranties regarding
                suggestions or recommendations of services or products offered or purchased through or in connection
                with the Services. THE SERVICES AND CONTENT ARE PROVIDED BY DEVORA (AND ITS LICENSORS AND SUPPLIERS)
              ...
              <p>
                ...
                DEVORA PARTIES BE LIABLE TO YOU OR TO ANY OTHER PERSON FOR (A) ANY INDIRECT, SPECIAL, INCIDENTAL,
                ...
                TO DEVORA IN CONNECTION WITH THE SERVICES IN THE TWELVE (12) MONTH PERIOD PRECEDING THIS APPLICABLE
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the Devora Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without Devora's prior written
              ...
              <p>
                ...
                disputes and claims with Devora and limits the manner in which you can seek relief from Devora. Both
                you and Devora acknowledge and agree that for the purposes of any dispute arising out of or relating
                to the subject matter of these Terms, Devora's officers, directors, employees and independent
              ...
              <p>
                The Rules will govern payment of all arbitration fees. Devora will pay all arbitration fees for claims
                less than seventy-five thousand ($75,000) dollars. Devora will not seek its attorneys' fees and costs
                in arbitration unless the arbitrator determines that your claim is frivolous.
              </p>

              <h4>Small Claims Court; Infringement</h4>
              <p>
                Either you or Devora may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                YOU AND DEVORA WAIVE ANY CONSTITUTIONAL AND STATUTORY RIGHTS TO GO TO COURT AND HAVE A TRIAL IN FRONT
                OF A JUDGE OR JURY. You and Devora are instead choosing to have claims and disputes resolved by
                ...
                you and Devora over whether to vacate or enforce an arbitration award, YOU AND DEVORA WAIVE ALL
              ...
              <p>
                ...
                Devora is entitled to arbitration; instead all claims and disputes will be resolved in a court as set
                forth in (g) below.
              </p>
              ...
              <p>
                ...
                agreement permits either you or Devora to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and Devora agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                the Devora may, in its sole discretion, do any of the foregoing on your behalf or for itself as it
                ...
                Terms shall otherwise remain in full force and effect and enforceable. You and Devora agree that these
                Terms are the complete and exclusive statement of the mutual understanding between you and Devora, and
                ...
                are not an employee, agent, partner, or joint venture of Devora, and you do not have any authority of
                any kind to bind Devora in any respect whatsoever.
              </p>

              <p>
                Except as expressly set forth in the section above regarding the arbitration agreement, you and Devora
