    ...
    <main data-page="home">
      ...
      <div data-component="content">
          ...
          <div data-slot="right">
            <button data-copy data-slot="command">
              <span>
                ...
                <span data-slot="highlight">mimo.xiaomi.com/install</span>
                <span> | bash</span>
              </span>
              <CopyStatus />
            </button>
        ...
        <footer data-component="footer">
          <div data-slot="cell">
            <a href="https://mimo.xiaomi.com/en/mimocode">MiMoCode</a>
          </div>
          <div data-slot="cell">
            <a href="https://github.com/XiaomiMiMo/MiMo-Code">{i18n.t("footer.github")}</a>
          </div>
          <div data-slot="cell">
            <a href="https://github.com/XiaomiMiMo/MiMo-Code/issues">Issues</a>
          </div>
        </footer>
      </div>
      ...
      <div data-component="legal">
        <span>
          ©2025 <a href="https://mimo.xiaomi.com">MiMo</a>
        </span>
      </div>
    </main>
  )
