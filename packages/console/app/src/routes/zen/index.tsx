...
import compareVideo from "../../asset/lander/devora-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/devora-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="devora:auth" content={loggedin() ? "true" : "false"} />
