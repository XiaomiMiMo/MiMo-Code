...
import productIcon from "../../asset/lander/desktop-app-icon.png"
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              ...
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g @mimo-ai/cli")}>
                <code>
                  npm i -g <strong>@mimo-ai/cli</strong>
                </code>
                <CopyStatus />
              </button>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <div data-component="download-row">
                ...
                <a href={language.route(getDownloadHref("darwin-arm64-zip"))} data-component="action-button">
              ...
              <div data-component="download-row">
                ...
                <a href={language.route(getDownloadHref("darwin-x64-zip"))} data-component="action-button">
                  {i18n.t("download.action.download")}
                </a>
              </div>
              <div data-component="download-row">
              ...
              <div data-component="download-row">
                ...
                <a href={language.route(getDownloadHref("linux-x64-tar"))} data-component="action-button">
                  {i18n.t("download.action.download")}
                </a>
              </div>
              <div data-component="download-row">
                ...
                <a href={language.route(getDownloadHref("linux-arm64-tar"))} data-component="action-button">
                  {i18n.t("download.action.download")}
                </a>
              </div>
            </div>
