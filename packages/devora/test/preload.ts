...
const dir = path.join(os.tmpdir(), "devora-test-data-" + process.pid)
...
process.env["DEVORA_TEST_TMPDIR_ROOT"] = fixtureRoot
afterAll(async () => {
...
process.env["DEVORA_MODELS_PATH"] = path.join(import.meta.dir, "tool", "fixtures", "models-api.json")
...
process.env["DEVORA_TEST_MANAGED_CONFIG_DIR"] = testManagedConfigDir
process.env["DEVORA_DISABLE_DEFAULT_PLUGINS"] = "true"

// Write the cache version file to prevent global/index.ts from clearing the cache
const cacheDir = path.join(dir, "cache", "devora")
...
delete process.env["DEVORA_SERVER_PASSWORD"]
delete process.env["DEVORA_SERVER_USERNAME"]
delete process.env["DEVORA_HOME"]

// Use in-memory sqlite
process.env["DEVORA_DB"] = ":memory:"
