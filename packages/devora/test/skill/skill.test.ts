...
process.env.DEVORA_DISABLE_COMPOSE_SKILLS = "true"
...
describe("skill", () => {
  it.live("discovers skills from .devora/skill/ directory", () =>
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Bun.write(
              path.join(dir, ".devora", "skill", "test-skill", "SKILL.md"),
              `---
name: test-skill
      ...
      (dir) =>
        withHome(
          ...
          Effect.gen(function* () {
            yield* Effect.promise(() =>
              Bun.write(
                path.join(dir, ".devora", "skill", "dir-skill", "SKILL.md"),
                `---
name: dir-skill
...
`,
            ...
            expect(dirs).toContain(path.join(dir, ".devora", "skill", "dir-skill"))
  ...
  it.live("discovers multiple skills from .devora/skill/ directory", () =>
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Promise.all([
              Bun.write(
                path.join(dir, ".devora", "skill", "skill-one", "SKILL.md"),
                `---
name: skill-one
...
`,
              ...
              Bun.write(
                path.join(dir, ".devora", "skill", "skill-two", "SKILL.md"),
                `---
name: skill-two
    ...
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Bun.write(
              path.join(dir, ".devora", "skill", "no-frontmatter", "SKILL.md"),
              `# No Frontmatter
...
`,
              ...
              Bun.write(
                path.join(dir, ".devora", "skill", "agent-skill", "SKILL.md"),
                `---
name: devora-skill
description: A skill in the .devora/skill directory.
---
...
`,
              ...
              Bun.write(
                path.join(dir, ".devora", "skills", "agent-skill", "SKILL.md"),
                `---
name: devora-skill
description: A skill in the .devora/skills directory.
---
