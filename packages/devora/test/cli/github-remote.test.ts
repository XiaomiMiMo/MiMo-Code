...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/devora.git")).toEqual({ owner: "sst", repo: "devora" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/devora")).toEqual({ owner: "sst", repo: "devora" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/devora.git")).toEqual({ owner: "sst", repo: "devora" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/devora")).toEqual({ owner: "sst", repo: "devora" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/devora.git")).toEqual({ owner: "sst", repo: "devora" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/devora")).toEqual({ owner: "sst", repo: "devora" })
})
