...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders DEVORA_CALLER", () => {
    process.env["DEVORA_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode DEVORA_CALLER", () => {
    process.env["DEVORA_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown DEVORA_CALLER", () => {
    process.env["DEVORA_CALLER"] = "unknown"
