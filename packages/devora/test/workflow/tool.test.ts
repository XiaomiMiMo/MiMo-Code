...
describe("WorkflowTool run", () => {
  ...
  const originalFlag = Flag.DEVORA_EXPERIMENTAL_WORKFLOW_TOOL
  beforeAll(() => {
    Flag.DEVORA_EXPERIMENTAL_WORKFLOW_TOOL = true
  })
  afterAll(() => {
    Flag.DEVORA_EXPERIMENTAL_WORKFLOW_TOOL = originalFlag
  })
