...
export interface Interface {
   ...
   * the CLI shutdown path so headless `devora run` invocations don't exit
...
export class Service extends Context.Service<Service, Interface>()("@devora/SessionCheckpoint") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const tryStartCheckpointWriter: (
      ...
      // and same-message.id thinking blocks aren't split. Devora's ToolPart
