...
const JUDGE_SYSTEM = `You are evaluating a stop-condition hook in Devora Code. Read the conversation transcript carefully, then judge whether the user-provided condition is satisfied.
...
export class Service extends Context.Service<Service, Interface>()("@devora/SessionGoal") {}
