 ...
 * TODO: lift to devora.json config (e.g. session.maxGoalReact).
 */
...
const OUTPUT_LENGTH_CONTINUATION_LIMIT = Flag.DEVORA_OUTPUT_LENGTH_CONTINUATION_LIMIT
const INVALID_OUTPUT_CONTINUATION_LIMIT = Flag.DEVORA_INVALID_OUTPUT_CONTINUATION_LIMIT
...
export class Service extends Context.Service<Service, Interface>()("@devora/SessionPrompt") {}
    ...
    const runLoop: (sessionID: SessionID, agentID?: string, task_id?: string) => Effect.Effect<MessageV2.WithParts> = Effect.fn(
      ...
      function* (sessionID: SessionID, agentID?: string, task_id?: string) {
        ...
        while (true) {
          ...
          // (explore/general/etc) spawned via devora's shared-sessionID
          ...
          const outcome: "break" | "continue" = yield* Effect.gen(function* () {
            ...
            if (isForkAgent) {
              ...
              // JSDoc in packages/devora/src/actor/spawn.ts for the full contract.
