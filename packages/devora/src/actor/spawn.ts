 ...
 * TODO: lift to devora.json config (e.g. actor.maxPreReact) and add per-hook
...
export class Service extends Context.Service<Service, Interface>()("@devora/Actor") {}
  ...
  Effect.gen(function* () {
    ...
    const forkWork = (input: {
      ...
      Effect.gen(function* () {
        ...
        // ignored: not reachable in normal usage (devora run sets no such rule, spawn doesn't
