import type * as SDK from "@devora-ai/sdk/v2"
...
const disabled = process.env["DEVORA_DISABLE_SHARE"] === "true" || process.env["DEVORA_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@devora/ShareNext") {}
