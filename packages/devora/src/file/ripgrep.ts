...
import { sanitizedProcessEnv } from "@/util/devora-process"
...
export class Service extends Context.Service<Service, Interface>()("@devora/Ripgrep") {}
    ...
    Effect.gen(function* () {
      ...
      const tree: Interface["tree"] = Effect.fn("Ripgrep.tree")(function* (input: TreeInput) {
        ...
        for (const file of list) {
          if (file.includes(".devora")) continue
