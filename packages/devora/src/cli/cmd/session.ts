...
function pagerCmd(): string[] {
  ...
  if (Flag.DEVORA_GIT_BASH_PATH) {
    const less = path.join(Flag.DEVORA_GIT_BASH_PATH, "..", "..", "usr", "bin", "less.exe")
...
export const SessionImportClaudeCommand = cmd({
  ...
  describe: "import Claude Code sessions (~/.claude/projects) into devora",
  builder: (yargs: Argv) =>
    yargs.option("force", {
