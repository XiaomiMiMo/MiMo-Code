export const dict: Record<string, string> = {
  ...
  "tui.tips.share": "Run {highlight}/share{/highlight} to create a public link to your conversation at devora.ai",
  ...
  "tui.tips.config_files":
    "Create {highlight}devora.json{/highlight} for server settings and {highlight}tui.json{/highlight} for TUI settings",
  "tui.tips.global_config": "Place TUI settings in {highlight}~/.config/devora/tui.json{/highlight} for global config",
  ...
  "tui.tips.mcp_oauth": "Devora auto-handles OAuth for remote MCP servers requiring auth",
  "tui.tips.custom_command":
    "Add {highlight}.md{/highlight} files to {highlight}.devora/command/{/highlight} to define reusable custom prompts",
  ...
  "tui.tips.custom_agent":
    "Add {highlight}.md{/highlight} files to {highlight}.devora/agent/{/highlight} for specialized AI personas",
  ...
  "tui.tips.formatter": "Devora auto-formats files using prettier, gofmt, ruff, and more",
  ...
  "tui.tips.lsp": "Devora uses LSP servers for intelligent code analysis",
  "tui.tips.custom_tool":
    "Create {highlight}.ts{/highlight} files in {highlight}.devora/tools/{/highlight} to define new LLM tools",
  "tui.tips.tool_scripts": "Tool definitions can invoke scripts written in Python, Go, etc",
  "tui.tips.plugins":
    "Add {highlight}.ts{/highlight} files to {highlight}.devora/plugin/{/highlight} for event hooks",
  "tui.tips.plugin_notify": "Use plugins to send OS notifications when sessions complete",
  "tui.tips.plugin_protect": "Create a plugin to prevent Devora from reading sensitive files",
  "tui.tips.run": "Use {highlight}devora run{/highlight} for non-interactive scripting",
  "tui.tips.continue": "Use {highlight}devora --continue{/highlight} to resume the last session",
  "tui.tips.attach_cli": "Use {highlight}devora run -f file.ts{/highlight} to attach files via CLI",
  "tui.tips.format_json": "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "tui.tips.serve": "Run {highlight}devora serve{/highlight} for headless API access to Devora",
  "tui.tips.attach_server": "Use {highlight}devora run --attach{/highlight} to connect to a running server",
  "tui.tips.upgrade": "Run {highlight}devora upgrade{/highlight} to update to the latest version",
  "tui.tips.auth_list": "Run {highlight}devora auth list{/highlight} to see all configured providers",
  "tui.tips.agent_create": "Run {highlight}devora agent create{/highlight} for guided agent creation",
  "tui.tips.github_trigger": "Use {highlight}/devora{/highlight} in GitHub issues/PRs to trigger AI actions",
  "tui.tips.github_install": "Run {highlight}devora github install{/highlight} to set up the GitHub workflow",
  ...
  "tui.tips.theme_files": "Create JSON theme files in {highlight}.devora/themes/{/highlight} directory",
  ...
  "tui.tips.debug_config": "Run {highlight}devora debug config{/highlight} to troubleshoot configuration",
  ...
  "tui.tips.docker": "Run {highlight}docker run -it --rm ghcr.io/SheriAkhtamov/Devora{/highlight} for containerized use",
  "tui.tips.zen": "Use {highlight}/connect{/highlight} with Devora for curated, tested models",
  ...
  "tui.command.devora.status.title": "View status",
  ...
  "tui.voice.error.no_auth": "Please log in to Devora first",
  ...
  "tui.dialog.login.devora": "Devora",
  "tui.dialog.login.devora.desc": "(Recommended)",
  "tui.dialog.login.devora_free": "Devora Auto (free)",
  "tui.dialog.login.devora_free.desc": "Anonymous free channel — no login required",
  "tui.dialog.login.devora_free.success": "Devora Auto (free) is ready — default model set to devora/devora-auto",
  "tui.dialog.login.devora_free.unavailable": "Devora Auto (free) provider not loaded",
  "cli.providers.select": "Select provider",
  "cli.providers.other": "Other provider",
  "cli.providers.devora.recommended_hint": "recommended",
  "cli.providers.devora_free.hint": "Anonymous free channel / devora-auto",
  "cli.providers.devora_free.verifying": "Verifying Devora Auto (free) channel...",
  "cli.providers.devora_free.ready": "Devora Auto (free) channel ready",
  "cli.providers.devora_free.failed": "Devora Auto (free) verification failed",
  "cli.providers.devora_free.default_set": "Default model set to devora/devora-auto (1M context, free)",
  "cli.providers.devora_free.usage_hint": "No login required — just run devora. For paid/premium models, choose Devora browser login instead.",
  "cli.providers.devora_login.decrypt_retry": "Decryption failed, please retry ({remaining} attempts left)",
  "cli.providers.devora_login.decrypt_exhausted": "Decryption failed, max retries reached",
  ...
  "tui.dialog.login.flow.title": "Devora Login",
