...
export const dict = {
  ...
  "tui.tips.share": "{highlight}/share{/highlight} を実行すると devora.ai に会話の公開リンクを作成します",
  ...
  "tui.tips.config_files":
    "サーバ設定は {highlight}devora.json{/highlight}、TUI 設定は {highlight}tui.json{/highlight} を作成します",
  "tui.tips.global_config":
    "TUI 設定をグローバルに置くなら {highlight}~/.config/devora/tui.json{/highlight} を使います",
  ...
  "tui.tips.mcp_oauth": "Devora は認証が必要なリモート MCP サーバの OAuth を自動処理します",
  "tui.tips.custom_command":
    "{highlight}.devora/command/{/highlight} に {highlight}.md{/highlight} ファイルを追加すると再利用可能なカスタムプロンプトを定義できます",
  ...
  "tui.tips.formatter": "Devora は prettier、gofmt、ruff などでファイルを自動整形します",
  ...
  "tui.tips.lsp": "Devora はインテリジェントなコード解析に LSP サーバを使います",
  "tui.tips.custom_tool":
    "{highlight}.devora/tools/{/highlight} に {highlight}.ts{/highlight} ファイルを作って新しい LLM ツールを定義します",
  ...
  "tui.tips.plugin_protect": "プラグインを書いて Devora が機密ファイルを読まないようにできます",
  "tui.tips.run": "{highlight}devora run{/highlight} で非対話的なスクリプト実行ができます",
  "tui.tips.continue": "{highlight}devora --continue{/highlight} で前回のセッションを再開します",
  "tui.tips.attach_cli": "{highlight}devora run -f file.ts{/highlight} で CLI からファイルを添付できます",
  "tui.tips.format_json": "{highlight}--format json{/highlight} を使うとスクリプトで機械可読な出力を得られます",
  "tui.tips.serve": "{highlight}devora serve{/highlight} を実行するとヘッドレスで Devora API にアクセスできます",
  "tui.tips.attach_server": "{highlight}devora run --attach{/highlight} で起動中のサーバに接続します",
  "tui.tips.upgrade": "{highlight}devora upgrade{/highlight} で最新バージョンに更新します",
  "tui.tips.auth_list": "{highlight}devora auth list{/highlight} で設定済みプロバイダを確認します",
  "tui.tips.agent_create": "{highlight}devora agent create{/highlight} でガイド付きエージェント作成を行います",
  "tui.tips.github_trigger": "GitHub の issue/PR で {highlight}/devora{/highlight} を入力すると AI を起動します",
  "tui.tips.github_install": "{highlight}devora github install{/highlight} で GitHub workflow を設定します",
  ...
  "tui.tips.theme_files": "{highlight}.devora/themes/{/highlight} ディレクトリに JSON テーマファイルを作成します",
  ...
  "tui.tips.debug_config": "{highlight}devora debug config{/highlight} で設定の問題を調査します",
  ...
  "tui.tips.docker":
    "{highlight}docker run -it --rm ghcr.io/SheriAkhtamov/Devora{/highlight} でコンテナ版を実行できます",
  "tui.tips.zen": "Devora と組み合わせて {highlight}/connect{/highlight} で厳選されたモデルを使えます",
  ...
  "tui.command.devora.status.title": "ステータスを表示",
  ...
  "tui.voice.error.no_auth": "まず Devora アカウントにログインしてください",
  ...
  "tui.dialog.login.devora_free.desc": "ログイン不要の匿名無料チャネル",
  "tui.dialog.login.devora_free.success": "Devora Auto (free) の準備完了 — デフォルトモデルを devora/devora-auto に設定しました",
  "tui.dialog.login.devora_free.unavailable": "Devora Auto (free) プロバイダーが読み込まれていません",

  // CLI: providers command (auth login)
  "cli.providers.select": "プロバイダーを選択",
  "cli.providers.other": "その他のプロバイダー",
  "cli.providers.devora.recommended_hint": "推奨",
  "cli.providers.devora_free.hint": "匿名無料チャネル / devora-auto",
  "cli.providers.devora_free.verifying": "Devora Auto (free) チャネルを検証中...",
  "cli.providers.devora_free.ready": "Devora Auto (free) チャネル準備完了",
  "cli.providers.devora_free.failed": "Devora Auto (free) の自己診断に失敗",
  "cli.providers.devora_free.default_set": "デフォルトモデルを devora/devora-auto に設定（1M コンテキスト、無料）",
  "cli.providers.devora_free.usage_hint":
    "ログイン不要 — そのまま devora を実行できます。有料/上位モデルを利用する場合は Devora ブラウザログインを選択してください。",
  "cli.providers.devora_login.decrypt_retry": "復号に失敗しました、再試行してください（残り {remaining} 回）",
  "cli.providers.devora_login.decrypt_exhausted": "復号に失敗しました、最大再試行回数に達しました",
