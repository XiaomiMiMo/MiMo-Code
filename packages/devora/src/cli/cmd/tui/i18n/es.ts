...
export const dict = {
  ...
  "tui.tips.share":
    "Ejecuta {highlight}/share{/highlight} para crear un enlace público a tu conversación en devora.ai",
  ...
  "tui.tips.config_files":
    "Crea {highlight}devora.json{/highlight} para la configuración del servidor y {highlight}tui.json{/highlight} para la TUI",
  "tui.tips.global_config":
    "Coloca la configuración de TUI en {highlight}~/.config/devora/tui.json{/highlight} como configuración global",
  "tui.tips.schema":
  ...
  "tui.tips.mcp_oauth":
    "Devora gestiona automáticamente OAuth para servidores MCP remotos que requieran autenticación",
  "tui.tips.custom_command":
    "Añade archivos {highlight}.md{/highlight} en {highlight}.devora/command/{/highlight} para definir indicaciones personalizadas reutilizables",
  ...
  "tui.tips.custom_agent":
    "Añade archivos {highlight}.md{/highlight} en {highlight}.devora/agent/{/highlight} para personajes de IA especializados",
  ...
  "tui.tips.formatter": "Devora formatea archivos automáticamente con prettier, gofmt, ruff y más",
  ...
  "tui.tips.lsp": "Devora usa servidores LSP para análisis inteligente de código",
  "tui.tips.custom_tool":
    "Crea archivos {highlight}.ts{/highlight} en {highlight}.devora/tools/{/highlight} para definir nuevas herramientas LLM",
  "tui.tips.tool_scripts":
    "Las definiciones de herramientas pueden invocar scripts en Python, Go, etc.",
  "tui.tips.plugins":
    "Añade archivos {highlight}.ts{/highlight} en {highlight}.devora/plugin/{/highlight} para enganchar eventos",
  ...
  "tui.tips.plugin_protect":
    "Crea un plugin que impida a Devora leer archivos sensibles",
  "tui.tips.run":
    "Usa {highlight}devora run{/highlight} para scripting no interactivo",
  "tui.tips.continue":
    "Usa {highlight}devora --continue{/highlight} para retomar la última sesión",
  "tui.tips.attach_cli":
    "Usa {highlight}devora run -f file.ts{/highlight} para adjuntar archivos vía CLI",
  "tui.tips.format_json":
    "Usa {highlight}--format json{/highlight} para obtener salida legible por máquina en scripts",
  "tui.tips.serve":
    "Ejecuta {highlight}devora serve{/highlight} para acceso headless a la API de Devora",
  "tui.tips.attach_server":
    "Usa {highlight}devora run --attach{/highlight} para conectarte a un servidor en ejecución",
  "tui.tips.upgrade":
    "Ejecuta {highlight}devora upgrade{/highlight} para actualizar a la última versión",
  "tui.tips.auth_list":
    "Ejecuta {highlight}devora auth list{/highlight} para ver todos los proveedores configurados",
  "tui.tips.agent_create":
    "Ejecuta {highlight}devora agent create{/highlight} para crear un agente con asistente guiado",
  "tui.tips.github_trigger":
    "Usa {highlight}/devora{/highlight} en issues/PR de GitHub para disparar acciones de IA",
  "tui.tips.github_install":
    "Ejecuta {highlight}devora github install{/highlight} para configurar el workflow de GitHub",
  "tui.tips.github_oc":
  ...
  "tui.tips.theme_files":
    "Crea archivos JSON de tema en el directorio {highlight}.devora/themes/{/highlight}",
  ...
  "tui.tips.debug_config":
    "Ejecuta {highlight}devora debug config{/highlight} para diagnosticar problemas de configuración",
  "tui.tips.print_logs":
  ...
  "tui.tips.docker":
    "Ejecuta {highlight}docker run -it --rm ghcr.io/SheriAkhtamov/Devora{/highlight} para uso en contenedor",
  "tui.tips.zen":
    "Usa {highlight}/connect{/highlight} con Devora para modelos seleccionados y probados",
  "tui.tips.agents_md":
  ...
  "tui.command.devora.status.title": "Ver estado",
  ...
  "tui.voice.error.no_auth": "Inicia sesión en Devora primero",
