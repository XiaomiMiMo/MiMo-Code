...
export const dict = {
  ...
  "tui.tips.share":
    "Exécutez {highlight}/share{/highlight} pour créer un lien public vers votre conversation sur devora.ai",
  ...
  "tui.tips.config_files":
    "Créez {highlight}devora.json{/highlight} pour la configuration serveur et {highlight}tui.json{/highlight} pour le TUI",
  "tui.tips.global_config":
    "Placez les paramètres TUI dans {highlight}~/.config/devora/tui.json{/highlight} comme configuration globale",
  ...
  "tui.tips.mcp_oauth":
    "Devora gère automatiquement OAuth pour les serveurs MCP distants nécessitant une authentification",
  "tui.tips.custom_command":
    "Ajoutez des fichiers {highlight}.md{/highlight} dans {highlight}.devora/command/{/highlight} pour définir des invites personnalisées réutilisables",
  ...
  "tui.tips.custom_agent":
    "Ajoutez des fichiers {highlight}.md{/highlight} dans {highlight}.devora/agent/{/highlight} pour des personas IA spécialisés",
  ...
  "tui.tips.formatter": "Devora formate automatiquement les fichiers avec prettier, gofmt, ruff, etc.",
  ...
  "tui.tips.lsp": "Devora utilise des serveurs LSP pour une analyse de code intelligente",
  "tui.tips.custom_tool":
    "Créez des fichiers {highlight}.ts{/highlight} dans {highlight}.devora/tools/{/highlight} pour définir de nouveaux outils LLM",
  "tui.tips.tool_scripts": "Les définitions d'outils peuvent invoquer des scripts en Python, Go, etc.",
  "tui.tips.plugins":
    "Ajoutez des fichiers {highlight}.ts{/highlight} dans {highlight}.devora/plugin/{/highlight} pour des hooks d'événements",
  ...
  "tui.tips.plugin_protect":
    "Créez un plugin pour empêcher Devora de lire des fichiers sensibles",
  "tui.tips.run": "Utilisez {highlight}devora run{/highlight} pour des scripts non interactifs",
  "tui.tips.continue": "Utilisez {highlight}devora --continue{/highlight} pour reprendre la dernière session",
  "tui.tips.attach_cli":
    "Utilisez {highlight}devora run -f file.ts{/highlight} pour joindre des fichiers via la CLI",
  "tui.tips.format_json":
    "Utilisez {highlight}--format json{/highlight} pour une sortie lisible par machine dans les scripts",
  "tui.tips.serve": "Exécutez {highlight}devora serve{/highlight} pour exposer l'API Devora en mode headless",
  "tui.tips.attach_server":
    "Utilisez {highlight}devora run --attach{/highlight} pour vous connecter à un serveur en cours",
  "tui.tips.upgrade": "Exécutez {highlight}devora upgrade{/highlight} pour passer à la dernière version",
  "tui.tips.auth_list":
    "Exécutez {highlight}devora auth list{/highlight} pour voir tous les fournisseurs configurés",
  "tui.tips.agent_create":
    "Exécutez {highlight}devora agent create{/highlight} pour créer un agent en mode guidé",
  "tui.tips.github_trigger":
    "Utilisez {highlight}/devora{/highlight} dans les issues/PR GitHub pour déclencher des actions IA",
  "tui.tips.github_install":
    "Exécutez {highlight}devora github install{/highlight} pour configurer le workflow GitHub",
  "tui.tips.github_oc":
  ...
  "tui.tips.theme_files":
    "Créez des fichiers de thème JSON dans le dossier {highlight}.devora/themes/{/highlight}",
  ...
  "tui.tips.debug_config":
    "Exécutez {highlight}devora debug config{/highlight} pour diagnostiquer la configuration",
  "tui.tips.print_logs":
  ...
  "tui.tips.docker":
    "Exécutez {highlight}docker run -it --rm ghcr.io/SheriAkhtamov/Devora{/highlight} pour une utilisation conteneurisée",
  "tui.tips.zen":
  ...
  "tui.command.devora.status.title": "Voir l'état",
  ...
  "tui.voice.error.no_auth": "Veuillez d'abord vous connecter à Devora",
  ...
  // Devora Auto (free) — TUI login dialog
  "tui.dialog.login.devora_free": "Devora Auto (free)",
  "tui.dialog.login.devora_free.desc": "Canal anonyme gratuit — aucune connexion requise",
  "tui.dialog.login.devora_free.success": "Devora Auto (free) est prêt — modèle par défaut défini sur devora/devora-auto",
  "tui.dialog.login.devora_free.unavailable": "Fournisseur Devora Auto (free) non chargé",

  // CLI: providers command (auth login)
  "cli.providers.select": "Sélectionner un fournisseur",
  "cli.providers.other": "Autre fournisseur",
  "cli.providers.devora.recommended_hint": "recommandé",
  "cli.providers.devora_free.hint": "Canal anonyme gratuit / devora-auto",
  "cli.providers.devora_free.verifying": "Vérification du canal Devora Auto (free)...",
  "cli.providers.devora_free.ready": "Canal Devora Auto (free) prêt",
  "cli.providers.devora_free.failed": "Échec de la vérification de Devora Auto (free)",
  "cli.providers.devora_free.default_set": "Modèle par défaut défini sur devora/devora-auto (contexte 1M, gratuit)",
  "cli.providers.devora_free.usage_hint":
    "Aucune connexion requise — exécutez simplement devora. Pour les modèles payants/premium, choisissez plutôt la connexion navigateur Devora.",
  "cli.providers.devora_login.decrypt_retry": "Échec du déchiffrement, veuillez réessayer ({remaining} tentatives restantes)",
  "cli.providers.devora_login.decrypt_exhausted": "Échec du déchiffrement, nombre maximal de tentatives atteint",
