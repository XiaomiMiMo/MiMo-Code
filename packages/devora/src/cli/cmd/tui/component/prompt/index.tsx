...
import type { AssistantMessage, FilePart, UserMessage } from "@devora-ai/sdk/v2"
...
export function Prompt(props: PromptProps) {
  ...
  async function voiceToggle() {
    ...
    const apiKey = devora.key
    const baseUrl = (devora.options?.baseURL as string) || "https://api.devora.com/v1"
