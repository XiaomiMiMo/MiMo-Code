...
import { base64Encode } from "@devora-ai/shared/util/encode"
...
import { Session, type Message } from "@devora-ai/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@devora-ai/ui/toast"
...
import { retry } from "@devora-ai/shared/util/retry"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://devora.ai/desktop-feedback")}
      renderPanel={() =>
