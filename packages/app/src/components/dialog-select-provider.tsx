...
export const DialogSelectProvider: Component = () => {
  ...
  const note = (id: string) => {
    ...
    if (id === "atomic-chat") return language.t("dialog.provider.atomicChat.note")
    if (id === "lmstudio") return language.t("dialog.provider.lmstudio.note")
    if (id === "ollama-cloud") return language.t("dialog.provider.ollama.note")
  }
