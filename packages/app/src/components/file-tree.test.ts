...
beforeAll(async () => {
  ...
  mock.module("@devora-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@devora-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@devora-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@devora-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
