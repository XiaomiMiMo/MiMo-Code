export const dict = {
  ...
  "command.memory.open": "Open memory search",
  ...
  "session.memory.tab.title": "Memory",
  "session.memory.tab.memory": "Files",
  "session.memory.tab.history": "History",
  "session.memory.search.label": "Search memory",
  "session.memory.search.placeholder": "Search project memory and checkpoints",
  "session.memory.search.empty": "No memory matches",
  "session.memory.preview": "Preview",
  "session.history.search.empty": "No history matches",
  "session.history.search.noTool": "message",
