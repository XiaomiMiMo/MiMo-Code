export const dict = {
  ...
  "settings.general.row.showFileTree.description": "Exibir o botão e o painel da árvore de arquivos nas sessões de desktop",
  "settings.general.row.showNavigation.title": "Controles de navegação",
  "settings.general.row.showNavigation.description": "Exibir os botões voltar e avançar na barra de título do desktop",
  "settings.general.row.showSearch.title": "Paleta de comandos",
  "settings.general.row.showSearch.description": "Exibir o botão de busca e paleta de comandos na barra de título do desktop",
  "settings.general.row.showTerminal.title": "Terminal",
  "settings.general.row.showTerminal.description": "Exibir o botão do terminal na barra de título do desktop",
  "settings.general.row.showStatus.title": "Status do servidor",
  "settings.general.row.showStatus.description": "Exibir o botão de status do servidor na barra de título do desktop",
