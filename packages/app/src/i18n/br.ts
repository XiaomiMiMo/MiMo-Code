export const dict = {
  ...
  "dialog.provider.devora.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.devora.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.devoraGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Devora",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Devora.",
  ...
  "provider.connect.devoraZen.line1":
    "Devora Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.devoraZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.devoraZen.visit.prefix": "Visite ",
  "provider.connect.devoraZen.visit.link": "devora.ai/zen",
  "provider.connect.devoraZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Devora.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Devora.",
  ...
  "dialog.plugins.empty": "Plugins configurados em devora.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Devora este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do Devora ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Devora",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (devora.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Devora ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Devora inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Devora dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Devora",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o Devora aparece no seu dispositivo",
  ...
  "settings.general.row.theme.description": "Personalize como o Devora é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Devora iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Devora.",
