export const dict = {
  ...
  "session.child.promptDisabled": "서브에이전트 세션에는 프롬프트를 보낼 수 없습니다.",
  ...
  "settings.general.row.showFileTree.description": "사이드바에 파일 트리 토글 표시",
  "settings.general.row.showNavigation.title": "탐색 컨트롤",
  "settings.general.row.showNavigation.description": "뒤로 및 앞으로 탐색 버튼 표시",
  "settings.general.row.showSearch.title": "명령 팔레트",
  "settings.general.row.showSearch.description": "검색 및 명령 팔레트 버튼 표시",
  "settings.general.row.showStatus.title": "서버 상태",
  "settings.general.row.showStatus.description": "서버 상태 버튼 표시",
  "settings.general.row.showTerminal.title": "터미널",
  "settings.general.row.showTerminal.description": "터미널 버튼 표시",
