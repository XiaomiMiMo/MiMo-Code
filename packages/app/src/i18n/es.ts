export const dict = {
  ...
  "session.child.promptDisabled": "Las sesiones de subagente no admiten prompts.",
  ...
  "settings.general.row.showFileTree.description": "Mostrar el botón y el panel del árbol de archivos en las sesiones de escritorio",
  "settings.general.row.showNavigation.title": "Controles de navegación",
  "settings.general.row.showNavigation.description": "Mostrar los botones atrás y adelante en la barra de título de escritorio",
  "settings.general.row.showSearch.title": "Paleta de comandos",
  "settings.general.row.showSearch.description": "Mostrar el botón de búsqueda y paleta de comandos en la barra de título de escritorio",
  ...
  "settings.general.row.showStatus.description": "Mostrar el botón de estado del servidor en la barra de título de escritorio",
