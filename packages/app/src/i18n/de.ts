...
export const dict = {
  ...
  "sidebar.empty.description": "Öffne ein Projekt, um zu beginnen",
  ...
  "settings.general.row.showFileTree.description": "Den Umschalter und das Panel für den Dateibaum in Desktop-Sitzungen anzeigen",
  "settings.general.row.showNavigation.title": "Navigationssteuerung",
  "settings.general.row.showNavigation.description": "Die Vor- und Zurück-Schaltflächen in der Desktop-Titelleiste anzeigen",
  "settings.general.row.showSearch.title": "Befehlspalette",
  "settings.general.row.showSearch.description": "Die Schaltfläche für Suche und Befehlspalette in der Desktop-Titelleiste anzeigen",
  "settings.general.row.showTerminal.title": "Terminal",
  "settings.general.row.showTerminal.description": "Die Terminal-Schaltfläche in der Desktop-Titelleiste anzeigen",
  "settings.general.row.showStatus.title": "Serverstatus",
  "settings.general.row.showStatus.description": "Die Schaltfläche für den Serverstatus in der Desktop-Titelleiste anzeigen",
