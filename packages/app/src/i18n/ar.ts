export const dict = {
  ...
  "session.child.promptDisabled": "لا يمكن إرسال المطالبات إلى جلسات الوكيل الفرعي.",
  ...
  "session.review.noUncommittedChanges": "لا توجد تغييرات غير مُلتزَم بها بعد",
  ...
  "settings.general.row.showFileTree.description": "إظهار زر ولوحة شجرة الملفات في جلسات سطح المكتب",
