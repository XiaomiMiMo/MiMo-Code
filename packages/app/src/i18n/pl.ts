export const dict = {
  ...
  "session.child.promptDisabled": "Sesje podagenta nie mogą otrzymywać promptów.",
  ...
  "settings.general.row.showFileTree.description": "Pokaż przełącznik i panel drzewa plików w sesjach na komputerze",
  "settings.general.row.showNavigation.title": "Elementy nawigacji",
  "settings.general.row.showNavigation.description": "Pokaż przyciski wstecz i dalej na pasku tytułu na komputerze",
  "settings.general.row.showSearch.title": "Paleta poleceń",
  "settings.general.row.showSearch.description": "Pokaż przycisk wyszukiwania i palety poleceń na pasku tytułu na komputerze",
  "settings.general.row.showTerminal.title": "Terminal",
  "settings.general.row.showTerminal.description": "Pokaż przycisk terminala na pasku tytułu na komputerze",
  "settings.general.row.showStatus.title": "Status serwera",
  "settings.general.row.showStatus.description": "Pokaż przycisk statusu serwera na pasku tytułu na komputerze",
