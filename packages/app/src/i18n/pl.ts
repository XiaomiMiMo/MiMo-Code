export const dict = {
  ...
  "session.child.promptDisabled": "Sesje podagentów nie mogą być inicjowane zapytaniami.",
  ...
  "settings.general.row.showFileTree.description": "Pokaż przełącznik drzewa plików na pasku bocznym",
  "settings.general.row.showNavigation.title": "Sterowanie nawigacją",
  "settings.general.row.showNavigation.description": "Pokaż przyciski nawigacji wstecz i dalej",
  "settings.general.row.showSearch.title": "Paleta poleceń",
  "settings.general.row.showSearch.description": "Pokaż przycisk wyszukiwania i palety poleceń",
  "settings.general.row.showStatus.title": "Status serwera",
  "settings.general.row.showStatus.description": "Pokaż przycisk statusu serwera",
  "settings.general.row.showTerminal.title": "Terminal",
  "settings.general.row.showTerminal.description": "Pokaż przycisk terminala",
