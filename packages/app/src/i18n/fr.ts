export const dict = {
  ...
  "session.child.promptDisabled": "Les sessions de sous-agent ne peuvent pas recevoir d'invite.",
  ...
  "settings.general.row.showFileTree.description": "Afficher le bouton et le panneau de l'arborescence des fichiers dans les sessions de bureau",
  ...
  "settings.general.row.showSearch.description": "Afficher le bouton de recherche et de palette de commandes dans la barre de titre du bureau",
  ...
  "settings.general.row.showStatus.description": "Afficher le bouton d'état du serveur dans la barre de titre du bureau",
