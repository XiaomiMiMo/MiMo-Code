export const dict = {
  ...
  "session.child.promptDisabled": "Les sessions de sous-agents ne peuvent pas être sollicitées.",
  ...
  "session.review.noUncommittedChanges": "Aucun changement non commité pour le moment",
  "session.review.noBranchChanges": "Aucun changement de branche pour le moment",
  ...
  "settings.general.row.showFileTree.description": "Afficher le bouton de basculement de l'arborescence dans la barre latérale",
  "settings.general.row.showNavigation.title": "Contrôles de navigation",
  "settings.general.row.showNavigation.description": "Afficher les boutons de navigation retour et avant",
  "settings.general.row.showSearch.title": "Palette de commandes",
  "settings.general.row.showSearch.description": "Afficher le bouton de recherche et la palette de commandes",
  "settings.general.row.showStatus.title": "État du serveur",
  "settings.general.row.showStatus.description": "Afficher le bouton d'état du serveur",
  "settings.general.row.showTerminal.title": "Terminal",
  "settings.general.row.showTerminal.description": "Afficher le bouton du terminal",
