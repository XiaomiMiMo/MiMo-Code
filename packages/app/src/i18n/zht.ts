...
export const dict = {
  ...
  "session.child.promptDisabled": "子代理工作階段無法傳送提示詞。",
  ...
  "sidebar.empty.description": "開啟一個專案以開始",
  ...
  "settings.general.row.showFileTree.description": "在桌面工作階段中顯示檔案樹切換按鈕與面板",
  "settings.general.row.showNavigation.title": "導覽控制項",
  "settings.general.row.showNavigation.description": "在桌面標題列中顯示返回與前進按鈕",
  "settings.general.row.showSearch.title": "命令面板",
  "settings.general.row.showSearch.description": "在桌面標題列中顯示搜尋與命令面板按鈕",
