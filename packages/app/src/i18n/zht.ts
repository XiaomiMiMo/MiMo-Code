...
export const dict = {
  ...
  "settings.general.row.showFileTree.description": "在側邊欄顯示檔案樹切換按鈕",
  "settings.general.row.showNavigation.title": "導航控制",
  "settings.general.row.showNavigation.description": "顯示返回和前進導航按鈕",
