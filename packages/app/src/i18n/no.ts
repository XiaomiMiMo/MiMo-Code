...
export const dict = {
  ...
  "session.child.promptDisabled": "Underagent-økter kan ikke motta prompts.",
  ...
  "settings.general.row.showFileTree.description": "Vis filtre-veksleren og -panelet i skrivebordsøkter",
  "settings.general.row.showNavigation.title": "Navigasjonskontroller",
  "settings.general.row.showNavigation.description": "Vis tilbake- og frem-knappene i skrivebordets tittellinje",
  "settings.general.row.showSearch.title": "Kommandopalett",
  "settings.general.row.showSearch.description": "Vis søke- og kommandopalett-knappen i skrivebordets tittellinje",
  "settings.general.row.showTerminal.title": "Terminal",
  "settings.general.row.showTerminal.description": "Vis terminal-knappen i skrivebordets tittellinje",
  "settings.general.row.showStatus.title": "Serverstatus",
  "settings.general.row.showStatus.description": "Vis serverstatus-knappen i skrivebordets tittellinje",
