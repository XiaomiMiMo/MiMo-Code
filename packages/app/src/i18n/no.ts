...
export const dict = {
  ...
  "dialog.provider.devora.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.devora.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.devoraGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Devora",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Devora.",
  ...
  "provider.connect.devoraZen.line1":
    "Devora Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.devoraZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.devoraZen.visit.prefix": "Besøk ",
  "provider.connect.devoraZen.visit.link": "devora.ai/zen",
  "provider.connect.devoraZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Devora.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Devora.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i devora.json",
  ...
  "dialog.server.description": "Bytt hvilken Devora-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Devora ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Devora-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (devora.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Devora ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Devora inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Devora-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Devora",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Devora ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Devora skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Devora er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Devora starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Devora.",
