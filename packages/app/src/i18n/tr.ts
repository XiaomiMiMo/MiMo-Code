...
export const dict = {
  ...
  "dialog.provider.devora.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.devora.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.devoraGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Devora tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Devora'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.devoraZen.line1":
    "Devora Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.devoraZen.visit.prefix": "",
  "provider.connect.devoraZen.visit.link": "devora.ai/zen",
  "provider.connect.devoraZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve Devora'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Devora'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler devora.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Devora sunucusuna bağlanacağını değiştirin.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Devora ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (devora.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Devora henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Devora ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Devora Masaüstü",
  ...
  "settings.desktop.wsl.description": "Devora sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.appearance.description": "Devora'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Devora'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Devora'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Devora başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Devora'un en son sürümünü kullanıyorsunuz.",
