export const dict = {
  ...
  "session.child.backToParent": "Назад к главной сессии.",
  ...
  "settings.general.row.showFileTree.description": "Показывать переключатель и панель дерева файлов в десктопных сессиях",
  "settings.general.row.showNavigation.title": "Элементы навигации",
  "settings.general.row.showNavigation.description": "Показывать кнопки «Назад» и «Вперёд» в строке заголовка десктопа",
  "settings.general.row.showSearch.title": "Палитра команд",
  "settings.general.row.showSearch.description": "Показывать кнопку поиска и палитры команд в строке заголовка десктопа",
  "settings.general.row.showTerminal.title": "Терминал",
  "settings.general.row.showTerminal.description": "Показывать кнопку терминала в строке заголовка десктопа",
  "settings.general.row.showStatus.title": "Статус сервера",
  "settings.general.row.showStatus.description": "Показывать кнопку статуса сервера в строке заголовка десктопа",
