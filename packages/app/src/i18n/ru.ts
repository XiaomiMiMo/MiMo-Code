export const dict = {
  ...
  "session.child.promptDisabled": "Сессии подагентов не могут получать запросы.",
  ...
  "settings.general.row.showFileTree.description": "Показать переключатель дерева файлов на боковой панели",
  "settings.general.row.showNavigation.title": "Элементы навигации",
  "settings.general.row.showNavigation.description": "Показать кнопки навигации назад и вперёд",
  "settings.general.row.showSearch.title": "Палитра команд",
  "settings.general.row.showSearch.description": "Показать кнопку поиска и палитры команд",
  "settings.general.row.showStatus.title": "Статус сервера",
  "settings.general.row.showStatus.description": "Показать кнопку статуса сервера",
  "settings.general.row.showTerminal.title": "Терминал",
  "settings.general.row.showTerminal.description": "Показать кнопку терминала",
