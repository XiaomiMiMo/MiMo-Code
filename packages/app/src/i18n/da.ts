export const dict = {
  ...
  "dialog.provider.devora.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.devora.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.devoraGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Devora",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Devora.",
  ...
  "provider.connect.devoraZen.line1":
    "Devora Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.devoraZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.devoraZen.visit.prefix": "Besøg ",
  "provider.connect.devoraZen.visit.link": "devora.ai/zen",
  "provider.connect.devoraZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Devora.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Devora.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i devora.json",
  ...
  "dialog.server.description": "Skift hvilken Devora-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af Devora ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Devora-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (devora.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Devora understøtter ikke MCP-godkendelse endnu.',
  ...
  "settings.desktop.wsl.description": "Kør Devora-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Devora",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan Devora ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om Devora følger systemets, lyst eller mørkt tema",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Devora starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Devora.",
