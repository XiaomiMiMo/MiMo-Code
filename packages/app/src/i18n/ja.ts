export const dict = {
  ...
  "settings.general.row.showFileTree.description": "サイドバーにファイルツリーのトグルを表示する",
  "settings.general.row.showNavigation.title": "ナビゲーションコントロール",
  "settings.general.row.showNavigation.description": "戻る・進むボタンを表示する",
  "settings.general.row.showSearch.title": "コマンドパレット",
  "settings.general.row.showSearch.description": "検索・コマンドパレットのボタンを表示する",
  "settings.general.row.showStatus.title": "サーバーステータス",
  "settings.general.row.showStatus.description": "サーバーステータスのボタンを表示する",
  "settings.general.row.showTerminal.title": "ターミナル",
  "settings.general.row.showTerminal.description": "ターミナルのボタンを表示する",
