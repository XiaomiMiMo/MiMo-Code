export const dict = {
  ...
  "dialog.provider.devora.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.devora.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.devoraGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Devora",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Devora-u.",
  ...
  "provider.connect.devoraZen.line1":
    "Devora Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.devoraZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.devoraZen.visit.prefix": "Posjeti ",
  "provider.connect.devoraZen.visit.link": "devora.ai/zen",
  "provider.connect.devoraZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Devora-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Devora-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u devora.json",
  ...
  "dialog.server.description": "Promijeni na koji se Devora server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Devora-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Devora timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (devora.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Devora još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Devora uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Devora server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Devora-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Devora izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Devora prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Devora-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Devora pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Devora-a.",
