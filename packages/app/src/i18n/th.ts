export const dict = {
  ...
  "session.child.promptDisabled": "เซสชันของซับเอเจนต์ไม่สามารถรับพรอมต์ได้",
  ...
  "settings.general.row.showFileTree.description": "แสดงปุ่มสลับและแผงแผนผังไฟล์ในเซสชันเดสก์ท็อป",
  "settings.general.row.showNavigation.title": "ปุ่มนำทาง",
  ...
  "settings.general.row.showSearch.description": "แสดงปุ่มค้นหาและแผงคำสั่งในแถบชื่อเดสก์ท็อป",
