...
- `.mimocode/plugins/` - plugin a livello progetto
...
1. Config globale (`~/.config/opencode/mimocode.jsonc`)
2. Config di progetto (`mimocode.jsonc`)
3. Directory plugin globale (`~/.config/opencode/plugins/`)
4. Directory plugin di progetto (`.mimocode/plugins/`)
...
Livelli: `debug`, `info`, `warn`, `error`. Vedi la [documentazione SDK](https://mimocode.ai/docs/sdk) per i dettagli.
