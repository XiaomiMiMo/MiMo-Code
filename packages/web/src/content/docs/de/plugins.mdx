...
- `.mimocode/plugins/` – Plugins auf Projektebene
...
1. Globale Konfiguration (`~/.config/opencode/mimocode.jsonc`)
2. Projektkonfiguration (`mimocode.jsonc`)
3. Globales Plugin-Verzeichnis (`~/.config/opencode/plugins/`)
4. Projekt-Plugin-Verzeichnis (`.mimocode/plugins/`)
...
Ebenen: `debug`, `info`, `warn`, `error`. Weitere Informationen finden Sie unter [SDK documentation](https://mimocode.ai/docs/sdk).
