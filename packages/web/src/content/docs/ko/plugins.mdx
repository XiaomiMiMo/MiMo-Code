...
1. 글로벌 구성 (`~/.config/opencode/mimocode.jsonc`)
2. 프로젝트 구성 (`mimocode.jsonc`)
3. 글로벌 플러그인 디렉토리 (`~/.config/opencode/plugins/`)
4. 프로젝트 플러그인 디렉토리 (`.mimocode/plugins/`)
...
레벨: `debug`, `info`, `warn`, `error`. [SDK 문서](https://mimocode.ai/docs/sdk)를 참고하세요.
