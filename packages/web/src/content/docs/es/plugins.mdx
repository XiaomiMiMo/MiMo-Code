...
1. Configuración global (`~/.config/opencode/mimocode.jsonc`)
2. Configuración del proyecto (`mimocode.jsonc`)
3. Directorio global de complementos (`~/.config/opencode/plugins/`)
4. Directorio de complementos del proyecto (`.mimocode/plugins/`)
...
Niveles: `debug`, `info`, `warn`, `error`. Consulte la [documentación del SDK](https://mimocode.ai/docs/sdk) para obtener más detalles.
