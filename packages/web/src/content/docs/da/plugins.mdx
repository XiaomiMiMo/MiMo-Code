...
- `.mimocode/plugins/` - Plugins på projektniveau
...
1. Global konfiguration (`~/.config/opencode/mimocode.jsonc`)
2. Projektkonfiguration (`mimocode.jsonc`)
3. Global plugin-mappe (`~/.config/opencode/plugins/`)
4. Projekt plugin bibliotek (`.mimocode/plugins/`)
...
Niveauer: `debug`, `info`, `warn`, `error`. Se [SDK documentation](https://mimocode.ai/docs/sdk) for detaljer.
