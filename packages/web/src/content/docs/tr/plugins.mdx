...
- `.mimocode/plugins/` - Proje düzeyinde eklentiler
...
1. Global config (`~/.config/opencode/mimocode.jsonc`)
2. Project config (`mimocode.jsonc`)
3. Global eklenti dizini (`~/.config/opencode/plugins/`)
4. Proje eklenti dizini (`.mimocode/plugins/`)
...
Seviyeler: `debug`, `info`, `warn`, `error`. Ayrıntılar için [SDK belgelerine](https://mimocode.ai/docs/sdk) bakın.
