...
- `.mimocode/plugins/` - Programtillegg på prosjektnivå
...
1. Global konfigurasjon (`~/.config/opencode/mimocode.jsonc`)
2. Prosjektkonfigurasjon (`mimocode.jsonc`)
3. Global plugin-katalog (`~/.config/opencode/plugins/`)
4. Prosjektpluginkatalog (`.mimocode/plugins/`)
...
Nivåer: `debug`, `info`, `warn`, `error`. Se [SDK dokumentasjon](https://mimocode.ai/docs/sdk) for detaljer.
