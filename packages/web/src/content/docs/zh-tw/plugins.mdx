...
1. 全域設定 (`~/.config/opencode/mimocode.jsonc`)
2. 專案設定 (`mimocode.jsonc`)
3. 全域外掛目錄 (`~/.config/opencode/plugins/`)
4. 專案外掛目錄 (`.mimocode/plugins/`)
...
日誌層級：`debug`、`info`、`warn`、`error`。詳情請參閱 [SDK 文件](https://mimocode.ai/docs/sdk)。
