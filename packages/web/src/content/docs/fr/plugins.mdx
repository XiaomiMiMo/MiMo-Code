...
- `.mimocode/plugins/` - Plugins au niveau du projet
...
1. Configuration globale (`~/.config/opencode/mimocode.jsonc`)
2. Configuration du projet (`mimocode.jsonc`)
3. Répertoire global des plugins (`~/.config/opencode/plugins/`)
4. Répertoire des plugins du projet (`.mimocode/plugins/`)
...
Niveaux : `debug`, `info`, `warn`, `error`. Voir la [documentation du SDK](https://mimocode.ai/docs/sdk) pour plus de détails.
