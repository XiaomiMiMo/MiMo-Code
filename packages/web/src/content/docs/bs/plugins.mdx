...
- `.mimocode/plugins/` - Dodaci na nivou projekta
...
1. Globalna konfiguracija (`~/.config/opencode/mimocode.jsonc`)
2. Konfiguracija projekta (`mimocode.jsonc`)
3. Globalni direktorij dodataka (`~/.config/opencode/plugins/`)
4. Direktorij dodataka projekta (`.mimocode/plugins/`)
...
Nivoi su: `debug`, `info`, `warn`, `error`. Pogledajte [SDK dokumentaciju](https://mimocode.ai/docs/sdk) za detalje.
