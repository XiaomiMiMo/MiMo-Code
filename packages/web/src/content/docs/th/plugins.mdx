...
- `.mimocode/plugins/` - ​​ปลั๊กอินระดับโครงการ
...
1. การกำหนดค่าส่วนกลาง (`~/.config/opencode/mimocode.jsonc`)
2. การกำหนดค่าโครงการ (`mimocode.jsonc`)
3. ไดเร็กทอรีปลั๊กอินสากล (`~/.config/opencode/plugins/`)
4. ไดเรกทอรีปลั๊กอินโครงการ (`.mimocode/plugins/`)
...
ระดับ: `debug`, `info`, `warn`, `error` ดู[SDKเอกสารประกอบ](https://mimocode.ai/docs/sdk)สำหรับรายละเอียด
