...
- `.mimocode/plugins/` - إضافات على مستوى المشروع
...
1. إعدادات عامة (`~/.config/opencode/mimocode.jsonc`)
2. إعدادات المشروع (`mimocode.jsonc`)
3. دليل الإضافات العام (`~/.config/opencode/plugins/`)
4. دليل إضافات المشروع (`.mimocode/plugins/`)
...
المستويات: `debug`, `info`, `warn`, `error`. راجع [توثيق SDK](https://mimocode.ai/docs/sdk) للتفاصيل.
