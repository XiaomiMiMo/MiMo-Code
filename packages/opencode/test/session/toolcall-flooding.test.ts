          ...
          (dir) =>
            Effect.gen(function* () {
              ...
              for (const round of Array.from({ length: rounds }, (_, index) => index)) {
                ...
                expect(recovery).toContain("All later tool calls were blocked because of flooding")
        ...
        yield* provideTmpdirInstance(
          (dir) =>
            Effect.gen(function* () {
              ...
              expect(reminder).toContain("All later tool calls were blocked because of flooding")
