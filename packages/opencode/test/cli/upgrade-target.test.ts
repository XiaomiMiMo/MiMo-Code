...
import { resolveUpgradeMethod, resolveUpgradeTarget } from "../../src/cli/cmd/upgrade"
import { Installation } from "../../src/installation"

describe("upgrade target resolution", () => {
  test("uses explicit method instead of detected curl method", () => {
    expect(resolveUpgradeMethod({ method: "npm", detectedMethod: "curl" })).toBe("npm")
  })
