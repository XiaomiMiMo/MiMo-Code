...
export const Flag = {
  ...
  // Defaults to false. Set MIMOCODE_ENABLE_SKILL_SEARCH_REMINDER=true (or 1)
  // to inject skill-search reminders into user queries.
  MIMOCODE_ENABLE_SKILL_SEARCH_REMINDER: truthy("MIMOCODE_ENABLE_SKILL_SEARCH_REMINDER"),
