  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all MiMoCode sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific MiMoCode session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new MiMoCode session for interacting with AI assistants and managing conversations.",
