  ...
  new Hono()
    ...
    .post(
      ...
      describeRoute({
        ...
        description:
          "Check for conflicts (active sessions or uncommitted changes) and auto-create a worktree if needed. Returns the worktree path if created, or null if no conflict.",
        ...
        responses: {
          200: {
            ...
            content: {
              "application/json": {
                schema: resolver(z.union([Worktree.Info, z.null()])),
              },
            },
          },
          ...errors(400),
      ...
      async (c) =>
        jsonRequest("ExperimentalRoutes.worktree.auto", c, function* () {
          ...
          // Conflict detected - create worktree
          const svc = yield* Worktree.Service
