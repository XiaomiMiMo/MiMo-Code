...
export const ProjectApi = HttpApi.make("project")
      ...
      .add(
        HttpApiEndpoint.get("list", root, {
          ...
          OpenApi.annotations({
            ...
            description: "Get a list of projects that have been opened with MiMoCode.",
          }),
        ),
        HttpApiEndpoint.get("current", `${root}/current`, {
          ...
          OpenApi.annotations({
            ...
            description: "Retrieve the currently active project that MiMoCode is working with.",
          }),
        ),
      )
      .annotateMerge(
  ...
  .annotateMerge(
    OpenApi.annotations({
      title: "MiMoCode experimental HttpApi",
      version: "0.0.1",
