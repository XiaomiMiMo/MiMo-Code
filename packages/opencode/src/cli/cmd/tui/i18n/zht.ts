...
export const dict = {
  ...
  "tui.dialog.login.mimo_free.unavailable": "MiMo Auto（免費）提供者未載入",
  "tui.dialog.login.import_claude": "從 Claude Code 匯入",
  "tui.dialog.login.other": "其他提供者",
  ...
  "cli.providers.select": "選擇提供者",
  "cli.providers.other": "其他提供者",
  ...
  "cli.providers.mimo_free.usage_hint": "無需登入 — 只需執行 mimo。如需付費/進階模型，請選擇 MiMo 瀏覽器登入。",
  "cli.providers.mimo_login.decrypt_retry": "解密失敗，請重試（剩餘 {remaining} 次嘗試）",
