...
export const dict = {
  ...
  "tui.command.loop_detect.disable.title": "關閉循環檢測",
  "tui.command.loop_detect.enable.title": "開啟循環檢測",
  "tui.toast.loop_detect.disabled": "已關閉循環檢測",
  "tui.toast.loop_detect.enabled": "已開啟循環檢測",
