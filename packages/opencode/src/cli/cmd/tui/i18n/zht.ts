...
export const dict = {
  ...
  "tui.dialog.login.mimo_free.desc": "匿名免費頻道 — 無需登入",
  "tui.dialog.login.mimo_free.success": "MiMo Auto（免費）已就緒 — 預設模型設為 mimo/mimo-auto",
  "tui.dialog.login.mimo_free.unavailable": "MiMo Auto（免費）服務商未載入",
  "tui.dialog.login.import_claude": "從 Claude Code 匯入",
  "tui.dialog.login.other": "其他服務商",
  "tui.dialog.login.import_claude.no_key": "未找到 Claude Code API 金鑰",
  ...
  "tui.dialog.login.flow.placeholder": "貼上驗證碼（或等待瀏覽器回呼）",
  "tui.dialog.login.flow.busy": "登入中...",
  "tui.dialog.login.flow.manual_hint": "瀏覽器未自動開啟？請手動造訪：",
  "tui.dialog.login.flow.waiting": "等待瀏覽器授權...",
  "tui.dialog.login.flow.invalid_code": "無效的驗證碼，請重試",

  // CLI providers
  "cli.providers.select": "選擇服務商",
  "cli.providers.other": "其他服務商",
  "cli.providers.mimo.recommended_hint": "推薦",
  "cli.providers.mimo_free.hint": "匿名免費頻道 / mimo-auto",
  "cli.providers.mimo_free.verifying": "正在驗證 MiMo Auto（免費）頻道...",
  "cli.providers.mimo_free.ready": "MiMo Auto（免費）頻道已就緒",
  "cli.providers.mimo_free.failed": "MiMo Auto（免費）驗證失敗",
  "cli.providers.mimo_free.default_set": "預設模型設為 mimo/mimo-auto（1M 上下文，免費）",
  "cli.providers.mimo_free.usage_hint": "無需登入 — 直接執行 mimo。如需付費/進階模型，請選擇 MiMo 瀏覽器登入。",
