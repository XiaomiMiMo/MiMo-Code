...
export const dict = {
  ...
  "tui.command.plugins.install.title": "Instalar plugin",
   ...
   // Background image
  "tui.command.worktree.list.title": "Árboles de trabajo",
  ...
  "tui.dialog.login.mimo_free.success": "MiMo Auto (gratis) listo — modelo predeterminado: mimo/mimo-auto",
  "tui.dialog.login.mimo_free.unavailable": "Proveedor MiMo Auto (gratis) no cargado",
  ...
  "cli.providers.mimo_free.default_set": "Modelo predeterminado: mimo/mimo-auto (1M contexto, gratis)",
  "cli.providers.mimo_free.usage_hint": "Sin inicio de sesión — solo ejecuta mimo. Para modelos premium, elige inicio de sesión MiMo.",
  "cli.providers.mimo_login.decrypt_retry": "Descifrado fallido, intenta de nuevo ({remaining} intentos restantes)",
  "cli.providers.mimo_login.decrypt_exhausted": "Descifrado fallido, máximo de intentos alcanzado",
