...
export const dict = {
  ...
  "tui.dialog.login.mimo_free.desc": "Canal gratuito anónimo — no requiere inicio de sesión",
  "tui.dialog.login.mimo_free.success": "MiMo Auto (gratis) está listo — modelo predeterminado establecido en mimo/mimo-auto",
  "tui.dialog.login.mimo_free.unavailable": "El proveedor MiMo Auto (gratis) no se ha cargado",
  "tui.dialog.login.import_claude": "Importar desde Claude Code",
  "tui.dialog.login.other": "Otro proveedor",
  "tui.dialog.login.import_claude.no_key": "No se encontró la clave API de Claude Code",
  ...
  "tui.dialog.login.flow.title": "Inicio de sesión de MiMo",
  "tui.dialog.login.flow.placeholder": "Pegar código (o esperar la respuesta del navegador)",
  ...
  "cli.providers.mimo_free.hint": "Canal gratuito anónimo / mimo-auto",
  "cli.providers.mimo_free.verifying": "Verificando el canal MiMo Auto (gratis)...",
  ...
  "cli.providers.mimo_free.default_set": "Modelo predeterminado establecido en mimo/mimo-auto (1M contexto, gratis)",
  "cli.providers.mimo_free.usage_hint": "No requiere inicio de sesión — ejecuta mimo. Para modelos de pago/premium, elige el inicio de sesión del navegador MiMo.",
