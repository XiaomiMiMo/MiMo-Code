...
export const dict = {
  ...
  // Hardcoded strings in TUI components
  "tui.sidebar.free_models": "MiMoCode 内置免费模型，开箱即用。",
  "tui.autocomplete.no_items": "无匹配项",
  "tui.dialog.provider.waiting_auth": "等待授权中...",
  "tui.dialog.provider.id": "服务商 ID",
  "tui.dialog.provider.name": "显示名称",
  ...
  "tui.dialog.model.id": "模型 ID",
  "tui.dialog.model.id_hint": "网关模型 ID",
  ...
  "tui.permission.once": "允许一次",
  "tui.permission.always": "始终允许",
  "tui.permission.reject": "拒绝",
  "tui.session.click_collapse": "点击折叠",
  ...
  "tui.dialog.workflow.resume": "恢复工作流",
