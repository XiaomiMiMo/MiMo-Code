...
export const dict = {
  ...
  "tui.command.loop_detect.disable.title": "关闭循环检测",
  "tui.command.loop_detect.enable.title": "开启循环检测",
  "tui.toast.loop_detect.disabled": "已关闭循环检测",
  "tui.toast.loop_detect.enabled": "已开启循环检测",
