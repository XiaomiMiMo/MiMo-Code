...
export const dict = {
  ...
  "tui.dialog.image.title": "Images de fond",
  "tui.dialog.image.import.option": "Choisir une nouvelle image…",
  "tui.dialog.image.import.title": "Importer une image de fond",
  ...
  "tui.dialog.image.import.success": "Image de fond importée",
  ...
  "tui.dialog.login.start_failed": "Échec de la connexion",
  ...
  "tui.dialog.login.flow.invalid_code": "Code non valide, veuillez réessayer",
