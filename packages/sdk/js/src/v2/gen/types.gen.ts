...
export type QuestionInfo = {
  ...
  key?: string
  /**
   * Template parameters for i18n interpolation (e.g. { plan: '.devora/plans/...' })
   */
  params?: {
    [key: string]: string
  }
...
/**
 * Server configuration for devora serve and web commands
 */
export type ServerConfig = {
  ...
  mdns?: boolean
  /**
   * Custom domain name for mDNS service (default: devora.local)
   */
  mdnsDomain?: string
  /**
...
export type Config = {
  ...
  server?: ServerConfig
  /**
   * Command configuration, see https://devora.ai/docs/commands
   */
  command?: {
    [key: string]: {
      template: string
  ...
  /**
   * Agent configuration, see https://devora.ai/docs/agents
   */
  agent?: {
    plan?: AgentConfig
    build?: AgentConfig
