...
export type HistoryAround = {
  session_id: string
  messages: Array<HistoryMessageContext>
}
...
export type MemorySearchData = {
  ...
  query: {
    ...
    workspace?: string
    /**
     * FTS query (BM25 over markdown bodies)
     */
    query: string
...
export type MemoryFileGetData = {
  ...
  query: {
    ...
    workspace?: string
    /**
     * Absolute path from a memory.search hit
     */
    path: string
  }
  url: "/memory/file"
...
export type MemoryFileGetErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type MemoryFileGetError = MemoryFileGetErrors[keyof MemoryFileGetErrors]

export type MemoryFileGetResponses = {
  /**
...
export type MemoryFileGetResponse = MemoryFileGetResponses[keyof MemoryFileGetResponses]

export type HistorySearchData = {
  body?: never
  path?: never
  query: {
    directory?: string
    workspace?: string
    /**
     * FTS query over conversation trajectory
     */
    query: string
    scope?: "project" | "global"
    session_id?: string
    /**
     * Comma-separated history kinds (e.g. user_text,assistant_text)
     */
    kind?: string
    tool_name?: string
    time_after?: number
...
export type HistorySearchErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type HistorySearchError = HistorySearchErrors[keyof HistorySearchErrors]

export type HistorySearchResponses = {
  /**
   * Ranked trajectory hits
   */
  200: Array<HistorySearchHit>
}

export type HistorySearchResponse = HistorySearchResponses[keyof HistorySearchResponses]

export type HistoryAroundData = {
  body?: never
  path?: never
  query: {
    directory?: string
...
export type HistoryAroundErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type HistoryAroundError = HistoryAroundErrors[keyof HistoryAroundErrors]

export type HistoryAroundResponses = {
  /**
   * Message window
   */
  200: HistoryAround
...
export type HistoryAroundResponse = HistoryAroundResponses[keyof HistoryAroundResponses]
