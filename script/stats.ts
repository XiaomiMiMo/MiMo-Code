...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/SheriAkhtamov/Devora/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for SheriAkhtamov/Devora...\n")
...
console.log("Fetching npm all-time downloads for devora-ai...\n")
const npmDownloads = await fetchNpmDownloads("devora-ai")
