...
Generates UPCOMING_CHANGELOG.md by running the mimocode changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for mimocode run (default: low)
      --quiet            Suppress mimocode command output unless it fails
