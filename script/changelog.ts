...
Generates UPCOMING_CHANGELOG.md by running the devora changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for devora run (default: low)
      --quiet            Suppress devora command output unless it fails
